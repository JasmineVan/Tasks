...
Procedure InitializeItemsInForm(Val Warnings)
	...
	// Footer.
	LabelText = NStr("ru = 'Завершить работу с программой?'; en = 'Do you want to exit the application?'; pl = 'Czy chcesz zamknąć aplikację?';de = 'Möchten Sie die Anwendung beenden?';ro = 'Doriți să părăsiți aplicația?';tr = 'Uygulamadan çıkmak ister misiniz?'; es_ES = '¿Quiere salir de la aplicación?'");
