...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	MessageText = NStr("ru = 'Пожалуйста, подождите...'; en = 'Please wait...'; pl = 'Proszę czekać…';de = 'Bitte warten...';ro = 'Așteptați...';tr = 'Lütfen bekleyin...'; es_ES = 'Por favor, espere...'");
...
Procedure ShowNotification()
	...
	ShowUserNotification(?(Notification.Text <> Undefined, Notification.Text, NStr("ru = 'Действие выполнено'; en = 'Operation completed.'; pl = 'Działanie zakończone';de = 'Aktion abgeschlossen';ro = 'Acțiunea este executată';tr = 'Eylem tamamlandı'; es_ES = 'Acción realizada'")), 
