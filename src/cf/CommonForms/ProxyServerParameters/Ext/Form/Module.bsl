...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If NOT Parameters.ProxySettingAtClient
		...
		Raise NStr("ru = 'Недостаточно прав доступа.
			...
			|
			|Serverul proxy este configurat de administrator.';
	...
	Else
		AutoTitle = False;
		Title = NStr("ru = 'Параметры прокси-сервера на сервере 1С:Предприятия'; en = 'Proxy server parameters on 1C:Enterprise server'; pl = 'Parametry serwera prozy na serwerze 1C:Enterprise';de = 'Proxy-Server-Einstellungen auf 1C:Enterprise Server';ro = 'Parametrii serverului proxy pe serverul 1C:Enterprise';tr = '1C:Enterprise sunucusunda proxy sunucu parametreleri'; es_ES = 'Parámetros del servidor proxy en el servidor de la 1C:Enterprise'");
