...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Parameters.Property("VariantPresentation") AND ValueIsFilled(Parameters.VariantPresentation) Then
		AutoTitle = False;
		Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Изменение варианта отчета ""%1""'; en = 'Modify report option %1'; pl = 'Zmień opcję  sprawozdania ""%1""';de = 'Ändern der Berichtsoption ""%1""';ro = 'Modificați opțiunea de raport ""%1""';tr = 'Rapor seçeneğini değiştir ""%1""'; es_ES = 'Cambiar la opción del informe ""%1""'"), Parameters.VariantPresentation);
	EndIf;
...
Procedure CompleteEditing(Command)
	...
	Else
		...
		#If WebClient Then
			SelectionResult.VariantModified = True; // For platform.
