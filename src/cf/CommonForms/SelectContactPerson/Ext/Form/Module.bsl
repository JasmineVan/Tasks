...
Procedure FindCommandExecute()
	...
	If IsBlankString(SearchString) Then
		ShowMessageBox(, NStr("ru = 'Не задана строка поиска.'; en = 'Search bar is not specified.'; pl = 'Search bar is not specified.';de = 'Search bar is not specified.';ro = 'Search bar is not specified.';tr = 'Search bar is not specified.'; es_ES = 'Search bar is not specified.'"));
		Return;
	EndIf;
...
Function FindByString()
	...
	Return Interactions.ExecuteContactsSearchByString(ThisObject);
