...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If TypeOf(Parameters.User) = Type("CatalogRef.ExternalUsers") Then
		Items.Profiles.Title = NStr("ru = 'Профили внешнего пользователя'; en = 'External user profiles'; pl = 'Zewnętrzne profile użytkowników';de = 'Externe Benutzerprofile';ro = 'Tip de utilizator extern';tr = 'Harici kullanıcı profilleri'; es_ES = 'Perfiles de usuario externo'");
	Else
		Items.Profiles.Title = NStr("ru = 'Профили пользователя'; en = 'User profiles'; pl = 'Profile użytkowników';de = 'Benutzerprofil';ro = 'Tip de utilizator';tr = 'Kullanıcı profilleri'; es_ES = 'Perfiles de usuario'");
	EndIf;
...
Procedure OnOpen(Cancel)
	...
	If TypeOf(FormOwner) <> Type("ManagedForm")
	 Or FormOwner.Window <> Window Then
		...
		AutoTitle = False;
		Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Права доступа (%1)'; en = 'Access rights (%1)'; pl = 'Prawa dostępu (%1)';de = 'Zugriffsrechte (%1)';ro = 'Drepturi de acces (%1)';tr = 'Erişim hakları (%1)'; es_ES = 'Derecho de acceso (%1)'"), String(Parameters.User));
	EndIf;
