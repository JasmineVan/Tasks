...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If SaaS.DataSeparationEnabled()
		...
		Common.MessageToUser(
			NStr("ru = 'Настройка подсистемы в разделенном режиме не поддерживается.'; en = 'Subsystem setup is not supported on the share mode.'; pl = 'Konfiguracja podsystemu nie jest obsługiwana w trybie podziału.';de = 'Die Konfiguration des Subsystems wird im Split-Modus nicht unterstützt.';ro = 'Configurația subsistemului în regim separat nu este susținută.';tr = 'Alt sistem yapılandırması bölünmüş modda desteklenmiyor.'; es_ES = 'Configuración del subsistema no está admitida en el modo de división.'"),,,, Cancel);
		Return;
	EndIf;
