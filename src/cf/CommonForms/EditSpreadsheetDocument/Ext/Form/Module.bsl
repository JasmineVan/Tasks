...
Procedure StartFileSavingDialog(Val CompletionHandler)
	...
	SaveFileDialog.Filter = NStr("ru = 'Табличный документ'; en = 'Spreadsheet documents'; pl = 'Dokument tabelaryczny';de = 'Tabellenkalkulationsdokument';ro = 'Document tabelar';tr = 'Elektronik tablo belgesi'; es_ES = 'Documento de la hoja de cálculo'") + " (*.mxl)|*.mxl";
...
Function NewDocumentName()
	Return NStr("ru = 'Новый'; en = 'New'; pl = 'Nowy';de = 'Neu';ro = 'Nou';tr = 'Yeni'; es_ES = 'Nuevo'");
EndFunction
...
Procedure SetTitle()
	...
	Title = DocumentName;
	If IsNew() Then
		Title = Title + " (" + NStr("ru = 'создание'; en = 'create'; pl = 'utwórz';de = 'erstellen';ro = 'creare';tr = 'oluştur'; es_ES = 'crear'") + ")";
	ElsIf EditingDenied Then
		Title = Title + " (" + NStr("ru = 'только просмотр'; en = 'read-only'; pl = 'tylko podgląd';de = 'nur ansehen';ro = 'doar vizualizare';tr = 'sadece görüntüleme'; es_ES = 'solo ver'") + ")";
	EndIf;
