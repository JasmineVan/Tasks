...
Function ClosingDatesPrepared(DataParameters)
	...
	For Each Row In Table Do
		...
		If Row.SettingsRecipient = Enums.PeriodClosingDatesPurposeTypes.ForAllInfobases Then
			Row.SettingsRecipientPresentation = NStr("ru = 'Для всех информационных баз, кроме указанных'; en = 'For all infobases except for the specified ones'; pl = 'Dla wszystkich baz informacyjnych, z wyjątkiem wskazanych';de = 'Für alle Informationsbasen außer den angegebenen';ro = 'Pentru toate bazele de informații, cu excepția celor specificate';tr = 'Belirtilenlerin dışında tüm veritabanları için'; es_ES = 'Para todas las infobases a excepción de las especificadas'");
		Else
			Row.SettingsRecipientPresentation = String(TypeOf(Row.SettingsRecipient)) + ":"
				+ ?(ValueIsFilled(Row.SettingsRecipient),
					...
					NStr("ru = 'Все информационные базы'; en = 'All infobases'; pl = 'Wszystkie bazy informacyjne';de = 'Alle Informationsbasen';ro = 'Toate bazele de informații';tr = 'Tüm veri tabanları'; es_ES = 'Todas las bases de información'"));
		EndIf;
