...
Function ClosingDatesPrepared(DataParameters)
	...
	For Each Row In Table Do
		...
		ElsIf ValueIsFilled(Row.Section) Then
			Row.ObjectPresentation = NStr("ru = 'Для всех объектов, кроме указанных'; en = 'For all objects except for the specified ones'; pl = 'Dla wszystkich obiektów, z wyjątkiem wskazanych';de = 'Für alle Objekte außer den angegebenen';ro = 'Pentru toate obiectele, cu excepția celor specificate';tr = 'Belirtilenlerin dışında tüm nesneler için'; es_ES = 'Para todos los objetos a excepción de los especificados'");
		Else
			Row.ObjectPresentation = NStr("ru = 'Для всех разделов и объектов, кроме указанных'; en = 'For all sections and objects except for the specified ones'; pl = 'Dla wszystkich sekcji i obiektów, z wyjątkiem wskazanych';de = 'Für alle Abschnitte und Objekte außer den angegebenen';ro = 'Pentru toate compartimentele și obiectele, cu excepția celor specificate';tr = 'Belirtilenlerin dışında tüm bölümler ve nesneler için'; es_ES = 'Para todos los secciones y objetos a excepción de los especificados'");
		EndIf;
		
		If ValueIsFilled(Row.Section) Then
			Row.SectionPresentation = String(Row.Section);
		Else
			Row.SectionPresentation = "<" + NStr("ru = 'Общая дата'; en = 'Single date'; pl = 'Wspólna data';de = 'Gemeinsame Datum';ro = 'Data comună';tr = 'Ortak tarih'; es_ES = 'Fecha común'") + ">";
		EndIf;
		
		If Row.SettingsRecipient = Enums.PeriodClosingDatesPurposeTypes.ForAllUsers Then
			Row.SettingsRecipientPresentation = NStr("ru = 'Для всех пользователей, кроме указанных'; en = 'For all users except for the specified ones'; pl = 'Dla wszystkich użytkowników, z wyjątkiem wskazanych';de = 'Für alle Benutzer außer den angegebenen';ro = 'Pentru toți utilizatorii, cu excepția celor specificați';tr = 'Belirtilenler dışındaki tüm kullanıcılar için'; es_ES = 'Para todos los usuarios a excepción de los especificados'");
		Else
		...
		If Row.SettingsOwner = Enums.PeriodClosingDatesPurposeTypes.ForAllUsers Then
			Row.SettingsOwnerPresentation = NStr("ru = 'Для всех пользователей, кроме указанных'; en = 'For all users except for the specified ones'; pl = 'Dla wszystkich użytkowników, z wyjątkiem wskazanych';de = 'Für alle Benutzer außer den angegebenen';ro = 'Pentru toți utilizatorii, cu excepția celor specificați';tr = 'Belirtilenler dışındaki tüm kullanıcılar için'; es_ES = 'Para todos los usuarios a excepción de los especificados'");
		Else
