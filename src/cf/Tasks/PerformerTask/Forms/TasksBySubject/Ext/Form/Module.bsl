...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = NStr("ru = 'Задачи по предмету'; en = 'Tasks by subject'; pl = 'Tasks by subject';de = 'Tasks by subject';ro = 'Tasks by subject';tr = 'Tasks by subject'; es_ES = 'Tasks by subject'");
