...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Задачи бизнес-процесса %1'; en = 'Tasks of business process %1'; pl = 'Tasks of business process %1';de = 'Tasks of business process %1';ro = 'Tasks of business process %1';tr = 'Tasks of business process %1'; es_ES = 'Tasks of business process %1'"), String(Parameters.FilterValue));
