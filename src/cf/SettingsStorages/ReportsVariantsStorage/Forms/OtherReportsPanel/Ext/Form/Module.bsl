...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Items.OtherReportOptionsGroup.Title = ReportDescription + " (" + NStr("ru = 'варианты отчета'; en = 'report options'; pl = 'warianty sprawozdania';de = 'Berichtsoptionen';ro = 'opțiuni rapoarte';tr = 'rapor seçenekleri'; es_ES = 'variantes del informe'") + "):";
...
Function SectionSubsystems(RootSection)
	...
	Index = 0;
	While Index < FoundItems.Count() Do
		RowsCollection = FoundItems[Index].Rows;
		Index = Index + 1;
