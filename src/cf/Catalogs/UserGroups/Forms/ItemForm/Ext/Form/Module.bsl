...
Function ExtendedPickFormParameters()
	...
	PickFormHeader = NStr("ru = 'Подбор участников группы пользователей'; en = 'Select group members'; pl = 'Wybierz uczestników grupy użytkowników';de = 'Wählen Sie Teilnehmer der Benutzergruppe aus';ro = 'Selectarea participanților grupului de utilizatori';tr = 'Kullanıcı grubun katılımcılarını seçin'; es_ES = 'Seleccionar participantes del grupo de usuarios'");
