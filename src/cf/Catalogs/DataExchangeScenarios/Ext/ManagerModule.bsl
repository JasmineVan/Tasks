...
Procedure CreateScenario(
	...
	Description = NStr("ru = 'Автоматическая синхронизация данных с %1'; en = 'Synchronize data with %1automatically'; pl = 'Automatyczna synchronizacja danych z %1';de = 'Automatische Datensynchronisation mit %1';ro = 'Sincronizare automata a datelor cu %1';tr = '%1 ile otomatik veri senkronizasyonu'; es_ES = 'Sincronización de datos automática con %1'");
...
Procedure SetScheduledJobParameters(ScheduledJobObject, JobSchedule, CurrentObject)
	...
	ScheduledJobDescription = NStr("ru = 'Выполнение обмена по сценарию: %1'; en = 'Exchange data by scenario: %1'; pl = 'Wykonanie wymiany zgodnie ze scenariuszem: %1';de = 'Der Austausch des Szenarios mit: %1';ro = 'Executarea schimbului conform scenariului: %1';tr = 'Senaryo kullanarak bozdurma: %1'; es_ES = 'Intercambio utilizando el escenario: %1'");
...
Procedure WriteScheduledJob(Cancel, ScheduledJobObject)
	...
	Except
		...
		MessageString = NStr("ru = 'Произошла ошибка при сохранении расписания выполнения обменов. Подробное описание ошибки: %1'; en = 'Cannot save the exchange schedule. Error description: %1'; pl = 'Wystąpił błąd podczas zapisywania harmonogramu wymiany. Opis błędu: %1';de = 'Beim Speichern des Austauschplans ist ein Fehler aufgetreten. Fehlerbeschreibung: %1';ro = 'A apărut o eroare la salvarea programului de schimb. Descrierea erorii: %1';tr = 'Bozdurma takvimini kaydederken bir hata oluştu. Hata açıklaması: %1'; es_ES = 'Ha ocurrido un error al guardar el horario de intercambio. Descripción de error: %1'");
