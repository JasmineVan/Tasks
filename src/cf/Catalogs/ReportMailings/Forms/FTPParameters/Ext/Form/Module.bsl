...
Procedure Fill(Command)
	If Server = "" Then
		FullAddress = NStr("ru = 'ftp://логин:пароль@сервер:порт/каталог/'; en = 'ftp://username:password@server:port/directory'; pl = 'ftp://username:password@server:port/directory';de = 'ftp://username:password@server:port/directory';ro = 'ftp://username:password@server:port/directory';tr = 'ftp://username:password@server:port/directory'; es_ES = 'ftp://username:password@server:port/directory'");
	Else
		If Username = "" Then
	...
	ShowInputString(Handler, FullAddress, NStr("ru = 'Введите полный ftp адрес'; en = 'Enter full ftp address'; pl = 'Enter full ftp address';de = 'Enter full ftp address';ro = 'Enter full ftp address';tr = 'Enter full ftp address'; es_ES = 'Enter full ftp address'"))
EndProcedure
