...
Function JobByMailingPresentation(MailingDescription)
	Return StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Рассылка отчетов: %1'; en = 'Report bulk email: %1'; pl = 'Report bulk email: %1';de = 'Report bulk email: %1';ro = 'Report bulk email: %1';tr = 'Report bulk email: %1'; es_ES = 'Report bulk email: %1'"), TrimAll(MailingDescription));
EndFunction
