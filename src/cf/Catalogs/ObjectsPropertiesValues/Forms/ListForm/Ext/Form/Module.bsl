	...
	If IsBlankString(TitleLine) Then
		...
		If ValueIsFilled(Property) Then
			...
			ElsIf SelectFolders Then
				TitleLine = NStr("ru = 'Выберите группу значений свойства %1'; en = 'Select a group of the %1 property values'; pl = 'Wybierz grupę wartości właściwości %1';de = 'Wählen Sie eine Gruppe von Werten für %1';ro = 'Selectați grupul de valori ale proprietății %1';tr = '%1 için değer grubunu seçin'; es_ES = 'Seleccionar un grupo de valores para %1'");
			Else
		...
		ElsIf Parameters.ChoiceMode Then
			...
			If SelectFolders Then
				TitleLine = NStr("ru = 'Выберите группу значений свойства'; en = 'Select a property value group'; pl = 'Wybierz grupę wartości właściwości';de = 'Wählen Sie eine Gruppe von Werten aus';ro = 'Selectați grupul de valori ale proprietății';tr = 'Değerler grubunu seçin'; es_ES = 'Seleccionar un grupo de valores'");
			Else
