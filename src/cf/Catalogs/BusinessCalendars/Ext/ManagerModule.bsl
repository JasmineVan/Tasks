...
Procedure Print(ObjectsArray, PrintParameters, PrintFormsCollection, PrintObjects, OutputParameters) Export
	...
	If Common.SubsystemExists("StandardSubsystems.Print") Then
		...
		ModulePrintManager.OutputSpreadsheetDocumentToCollection(
				...
				"BusinessCalendar", NStr("ru = 'Производственный календарь'; en = 'Business calendar'; pl = 'Kalendarz biznesowy';de = 'Geschäftskalender';ro = 'Calendarul zilelor de lucru';tr = 'İş günleri takvimi'; es_ES = 'Calendario de los días laborales'"),
...
//	 GenerateFullSet - an optional parameter, Boolean, if false, only data on differences from the default calendar will be generated.
//
// Returns:
...
Function DefaultBusinessCalendars()
	...
	Except
		EventName = NStr("ru = 'Календарные графики.Получение календарей из классификатора'; en = 'Calendar schedules.Get calendars from classifier'; pl = 'Harmonogramy kalendarzowe.Pobieranie kalendarzy z klasyfikatora';de = 'Kalenderzeitpläne. Abrufen von Kalendern aus dem Klassifikator';ro = 'Programe calendaristice. Obținerea calendarelor din clasificator';tr = 'Takvim grafikler. Sınıflandırıcıdan takvim alma'; es_ES = 'Horarios. Recepción de los calendarios del clasificador'", Common.DefaultLanguageCode());
		MessageText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Не удалось получить список производственных календарей из классификатора.
                  ...
                  |%1';
                  |ro = 'Eșec la obținerea listei calendarelor de afaceri din clasificator.
                  |Lista de calendare este obținută din macheta furnizată.
                  |%1';
...
Function BusinessCalendarPrintForm(PrintFormPreparationParameters)
	...
	While SelectionByYear.Next() Do
		...
		While SelectionByQuarter.Next() Do
			...
			QuarterNumber.Parameters.QuarterNumber = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 квартал'; en = 'quarter %1'; pl = 'kwartał %1';de = 'Quartal %1';ro = 'sfert %1';tr = 'çeyrek yıl %1'; es_ES = 'trimestre %1'"), SelectionByQuarter.CalendarQuarter);
			...
			MonthColumn.Parameters.MonthName 		= StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 квартал'; en = 'quarter %1'; pl = 'kwartał %1';de = 'Quartal %1';ro = 'sfert %1';tr = 'çeyrek yıl %1'; es_ES = 'trimestre %1'"), SelectionByQuarter.CalendarQuarter);
			SpreadsheetDocument.Join(MonthColumn);
			...
			If SelectionByQuarter.CalendarQuarter = 2 
				...
				MonthColumn.Parameters.MonthName 		= StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 полугодие'; en = 'half year %1'; pl = '%1 półrocze';de = '%1 Halbjahr';ro = 'semestrul %1';tr = '%1 yarım yıl'; es_ES = '%1 medio año'"), SelectionByQuarter.CalendarQuarter / 2);
				SpreadsheetDocument.Join(MonthColumn);
			EndIf;
		...
		MonthColumn.Parameters.MonthName 		= StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 год'; en = 'year %1'; pl = '%1 rok';de = '%1 Jahr';ro = 'anul %1';tr = '%1 yıl'; es_ES = '%1 año'"), Format(SelectionByYear.CalendarYear, "NG="));
		SpreadsheetDocument.Join(MonthColumn);
	...
	MonthColumn.Parameters.WorkTime36 	= WorkTime36Year;
	MonthColumn.Parameters.WorkTime24 	= WorkTime24Year;
	MonthColumn.Parameters.MonthName 		= StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 год'; en = 'year %1'; pl = '%1 rok';de = '%1 Jahr';ro = 'anul %1';tr = '%1 yıl'; es_ES = '%1 año'"), Format(YearNumber, "NG="));
	...
	MonthColumn.Parameters.MonthName 		= NStr("ru = 'Среднемесячное количество'; en = 'Average per month'; pl = 'Średnia miesięczna ilość';de = 'Durchschnittliche monatliche Menge';ro = 'Cantitatea medie lunară';tr = 'Ortalama aylık miktar'; es_ES = 'Cantidad mensual media'");
	SpreadsheetDocument.Join(MonthColumn);
