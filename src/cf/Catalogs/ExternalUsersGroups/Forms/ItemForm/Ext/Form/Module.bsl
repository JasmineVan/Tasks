...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Not UsersInternal.ExternalUsersEmbedded() Then
		Raise NStr("ru = 'Внешние пользователи не предусмотрены в данной версии программы.'; en = 'This application version does not support external users.'; pl = 'Użytkownicy zewnętrzni nie są przewidziani w tej wersji programu.';de = 'Externe Benutzer werden in dieser Version des Programms nicht unterstützt.';ro = 'În această versiune a aplicației nu sunt prevăzuți utilizatorii externi.';tr = 'Programın bu sürümünde dış kullanıcılar öngörülmedi.'; es_ES = 'Usuarios externos no están previstos en esta versión del programa.'");
	EndIf;
...
Procedure CompositionDrag(Item, DragParameters, StandardProcessing, Row, Field)
	...
	If UserMessage <> Undefined Then
		ShowUserNotification(
			NStr("ru = 'Перемещение пользователей'; en = 'Move users'; pl = 'Przenieś użytkowników';de = 'Verschieben Sie Benutzer';ro = 'Mutați utilizatorii';tr = 'Kullanıcıları taşıyın'; es_ES = 'Mover a los usuarios'"), , UserMessage, PictureLib.Information32);
	EndIf;
...
Procedure SelectPurpose(Command)
	...
	UsersInternalClient.SelectPurpose(ThisObject, NStr("ru = 'Выбор вида пользователей'; en = 'Select users type'; pl = 'Wybierz typ użytkowników';de = 'Auswahl des Benutzertyps';ro = 'Selectarea tipului utilizatorilor';tr = 'Kullanıcı türünün seçimi'; es_ES = 'Selección del tipo de usuario'"), False, False, NotifyDescription);
...
Function ExtendedPickFormParameters()
	...
	PickFormHeader = NStr("ru = 'Подбор участников группы внешних пользователей'; en = 'Select external user group members'; pl = 'Wybierz uczestników zewnętrznej grupy użytkowników';de = 'Wählen Sie Teilnehmer der externen Benutzergruppe';ro = 'Selectarea participanților grupului de utilizatori externi';tr = 'Harici kullanıcı grubun üyelerini seçin'; es_ES = 'Seleccionar participantes del grupo de usuarios externos'");
