...
Procedure SendAndReceiveMessages(Command)
	...
	If IsSessionWithSetSeparatorsValues Then
		MessageText = NStr("ru = 'Обработка сообщений возможна только в неразделенном сеансе администратора сервиса.'; en = 'Message handling is available only during a shared session of the SaaS administrator.'; pl = 'Wiadomości mogą być przetwarzane tylko w niepodzielnej sesji administratora usług.';de = 'Nachrichten können nur in einer ungeteilten Sitzung des Dienstadministrators verarbeitet werden.';ro = 'Mesajele pot fi procesate numai într-o sesiune nedistribuită a administratorului de servicii.';tr = 'Mesajlar sadece bölünmemiş bir servis yöneticisi oturumunda işlenebilir.'; es_ES = 'Mensajes pueden procesarse solo en una sesión no dividida del administrador de servicios.'");
