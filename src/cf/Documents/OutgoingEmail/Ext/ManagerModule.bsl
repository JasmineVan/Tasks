...
Procedure ProcessDataForMigrationToNewVersion(Parameters) Export
	...
	While ObjectsToProcess.Next() Do
		...
		Except
			...
			MessageText = NStr("ru = 'Не удалось обработать %ObjectName%: %Ref% по причине: %Reason%'; en = 'Cannot process %ObjectName%: %Ref% for the reason: %Reason%'; pl = 'Cannot process %ObjectName%: %Ref% for the reason: %Reason%';de = 'Cannot process %ObjectName%: %Ref% for the reason: %Reason%';ro = 'Cannot process %ObjectName%: %Ref% for the reason: %Reason%';tr = 'Cannot process %ObjectName%: %Ref% for the reason: %Reason%'; es_ES = 'Cannot process %ObjectName%: %Ref% for the reason: %Reason%'");
