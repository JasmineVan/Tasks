...
Procedure EndTimeOnChange(Item)
	...
	If BegOfDay(Object.EndDate) + ExtractTime(EndTime) < Object.StartDate Then
		ClearMessages();
		CommonClient.MessageToUser(NStr("ru='Время окончания не может быть меньше времени начала.'; en = 'End time cannot be less than the start time.'; pl = 'End time cannot be less than the start time.';de = 'End time cannot be less than the start time.';ro = 'End time cannot be less than the start time.';tr = 'End time cannot be less than the start time.'; es_ES = 'End time cannot be less than the start time.'"),,"EndTime");
...
Procedure EndDateOnChange(Item)
	...
	If BegOfDay(EndDate) + ExtractTime(EndTime) < Object.StartDate Then
		...
		If BegOfDay(EndDate) < BegOfDay(StartDate) Then
			CommonClient.MessageToUser(NStr("ru='Дата окончания не может быть меньше даты начала.'; en = 'The end date cannot be earlier than the start date.'; pl = 'The end date cannot be earlier than the start date.';de = 'The end date cannot be earlier than the start date.';ro = 'The end date cannot be earlier than the start date.';tr = 'The end date cannot be earlier than the start date.'; es_ES = 'The end date cannot be earlier than the start date.'"),,"EndDate");
		Else
			CommonClient.MessageToUser(NStr("ru='Время окончания не может быть меньше времени начала.'; en = 'End time cannot be less than the start time.'; pl = 'End time cannot be less than the start time.';de = 'End time cannot be less than the start time.';ro = 'End time cannot be less than the start time.';tr = 'End time cannot be less than the start time.'; es_ES = 'End time cannot be less than the start time.'"),,"EndTime");
		EndIf;
