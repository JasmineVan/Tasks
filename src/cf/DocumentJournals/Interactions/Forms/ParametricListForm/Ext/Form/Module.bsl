...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If EmailOnly Then
		TitleParticipantsMail =  NStr("ru = 'Кому, от'; en = 'To, from'; pl = 'To, from';de = 'To, from';ro = 'To, from';tr = 'To, from'; es_ES = 'To, from'");
...
Procedure InteractionsTreeBeforeDeleteRow(Item, Cancel)
	...
	If Items.InteractionsTree.SelectedRows.Count() > 0 Then
		...
		If HasItemsMarkedForDeletion Then
			QuestionText = NStr("ru = 'Снять с выделенных элементов пометку на удаление?'; en = 'Clear marks for deletion of the selected items?'; pl = 'Clear marks for deletion of the selected items?';de = 'Clear marks for deletion of the selected items?';ro = 'Clear marks for deletion of the selected items?';tr = 'Clear marks for deletion of the selected items?'; es_ES = 'Clear marks for deletion of the selected items?'");
		Else
			QuestionText = NStr("ru = 'Пометить выделенные строки на удаление?'; en = 'Mark the selected lines for deletion?'; pl = 'Mark the selected lines for deletion?';de = 'Mark the selected lines for deletion?';ro = 'Mark the selected lines for deletion?';tr = 'Mark the selected lines for deletion?'; es_ES = 'Mark the selected lines for deletion?'");
		EndIf;
...
Procedure DeferReviewExecute(Command)
	...
	ShowInputDate(OnCloseNotifyHandler, ProcessingDate, NStr("ru = 'Отработать после'; en = 'Process after'; pl = 'Process after';de = 'Process after';ro = 'Process after';tr = 'Process after'; es_ES = 'Process after'"));
...
Function CorrectChoice()
	...
	If Items.TreeListPages.CurrentPage = Items.ListPage Then
		...
		For Each Item In Items.List.SelectedRows Do
			If TypeOf(Item) <> Type("DynamicalListGroupRow") Then
				Return True;
			EndIf;
		EndDo;
...
Procedure PagesManagementServer()
	...
	If InTreeStructure Then
		...
		Commands.SwitchViewMode.ToolTip = NStr("ru = 'Установить режим просмотра в виде списка'; en = 'Set view mode as a list'; pl = 'Set view mode as a list';de = 'Set view mode as a list';ro = 'Set view mode as a list';tr = 'Set view mode as a list'; es_ES = 'Set view mode as a list'");
	...
	Else
		...
		Commands.SwitchViewMode.ToolTip = NStr("ru = 'Установить режим просмотра в виде дерева'; en = 'Set view mode as a tree'; pl = 'Set view mode as a tree';de = 'Set view mode as a tree';ro = 'Set view mode as a tree';tr = 'Set view mode as a tree'; es_ES = 'Set view mode as a tree'");
