...
Procedure SelectAndClose(Result = Undefined, AdditionalParameters = Undefined) Export
	...
	If Folder <> CurrentFolder Then
		InteractionsServerCall.SetEmailFolder(Email,Folder);
	EndIf;
...
Procedure AvailabilityControl()
	...
	If EmailType = "OutgoingEmail" Then
		Items.Headers.Title = NStr("ru='Идентификаторы'; en = 'IDs'; pl = 'IDs';de = 'IDs';ro = 'IDs';tr = 'IDs'; es_ES = 'IDs'");
		...
		EndIf;
	Else
		Items.SentReceived.Title = NStr("ru='Получено'; en = 'ReceivedEmails'; pl = 'ReceivedEmails';de = 'ReceivedEmails';ro = 'ReceivedEmails';tr = 'ReceivedEmails'; es_ES = 'ReceivedEmails'");
