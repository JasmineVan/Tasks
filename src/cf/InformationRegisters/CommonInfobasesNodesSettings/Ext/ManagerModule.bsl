...
Procedure ProcessDataForMigrationToNewVersion(Parameters) Export
	...
	If Processed = 0 AND RecordsWithIssuesCount <> 0 Then
		MessageText = StringFunctionsClientServer.SubstituteParametersToString(
			NStr("ru = 'Процедуре РегистрыСведений.ОбщиеНастройкиУзловИнформационныхБаз.ОбработатьДанныеДляПереходаНаНовуюВерсию не удалось обработать некоторые записи узлов обмена (пропущены): %1'; en = 'The InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion procedure cannot process some exchange node records (skipped): %1'; pl = 'Procedura InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion nie udało się opracować niektórych zapisów węzłów wymiany (pominięte): %1';de = 'Das Verfahren InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion kann einige Austauschknotensätze nicht verarbeiten (übersprungen): %1';ro = 'Procedura InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion nu poate procesa unele înregistrări în nodul de schimb (omis): %1';tr = 'BilgiKaydedicileri.VeriAlışverişiÜnitelerininAyarlarınıKaldır.YeniSürümeGeçişİçinVerilerinİşlenmesi prosedürü veri alışverişi ünitesinin bazı kayıtlarını işleyemedi (atlatıldı): %1'; es_ES = 'El procedimiento InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion no ha podido procesar unos registros del nodo de cambio (saltados): %1'"), 
	...
	Else
		WriteLogEvent(InfobaseUpdate.EventLogEvent(), EventLogLevel.Information,
			...
			NStr("ru = 'Процедура РегистрыСведений.ОбщиеНастройкиУзловИнформационныхБаз.ОбработатьДанныеДляПереходаНаНовуюВерсию обработала очередную порцию записей: %1'; en = 'The InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion procedure processed records: %1'; pl = 'Procedura InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion opracowała kolejną porcję zapisów: %1';de = 'Das Verfahren InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion verarbeitet Datensätze: %1';ro = 'Înregistrările prelucrate în procedura InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion: %1';tr = 'BilgiKaydedicileri.VeriAlışverişiAyarlarınıKaldır.YeniSürümeGeçişİçinVerilerinİşlenmesi prosedürü veri alışverişi ünitesinin sıradaki kayıt partisini işledi: %1'; es_ES = 'El procedimiento InformationRegisters.CommonInfobasesNodesSettings.ProcessDataForMigrationToNewVersion ha procesado una porción de registros: %1'"),
			Processed));
	EndIf;
