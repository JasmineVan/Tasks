...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Исполнители роли ""%1""'; en = 'Assignees for role: %1'; pl = 'Assignees for role: %1';de = 'Assignees for role: %1';ro = 'Assignees for role: %1';tr = 'Assignees for role: %1'; es_ES = 'Assignees for role: %1'"), Role);
...
Procedure BeforeWrite(Cancel, WriteParameters)
	For each LinePerformer In RecordSet Do
		If NOT ValueIsFilled(LinePerformer.Performer) Then
			ShowMessageBox(, NStr("ru='Необходимо указать исполнителей.'; en = 'Specify assignees.'; pl = 'Specify assignees.';de = 'Specify assignees.';ro = 'Specify assignees.';tr = 'Specify assignees.'; es_ES = 'Specify assignees.'"));
			Cancel = True;
		EndIf;
	EndDo;
EndProcedure
...
Procedure Select(Command)
	...
	If RoleIsAvailableToExternalUsers AND RoleIsAvailableToUsers Then
		...
		Choice.Add("ExternalUser", NStr("ru = 'Внешний пользователь'; en = 'External user'; pl = 'External user';de = 'External user';ro = 'External user';tr = 'External user'; es_ES = 'External user'"));
		Choice.Add("User", NStr("ru = 'Пользователь'; en = 'User'; pl = 'User';de = 'User';ro = 'User';tr = 'User'; es_ES = 'User'"));
		NotifyDescription = New NotifyDescription("AfterUserTypeChoice", ThisObject);
		Choice.ShowChooseItem(NotifyDescription, NStr("ru = 'Выберите тип пользователя'; en = 'Select user type'; pl = 'Select user type';de = 'Select user type';ro = 'Select user type';tr = 'Select user type'; es_ES = 'Select user type'"));
