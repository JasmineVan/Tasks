...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Performers.Parameters.SetParameterValue("NoAddressObject", NStr("ru='<Без объекта адресации>'; en = '<Without addressing object>'; pl = '<Without addressing object>';de = '<Without addressing object>';ro = '<Without addressing object>';tr = '<Without addressing object>'; es_ES = '<Without addressing object>'"));
