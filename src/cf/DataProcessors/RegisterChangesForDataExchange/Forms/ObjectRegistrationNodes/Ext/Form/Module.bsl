...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	TitleParts.Add(NStr("ru = 'Регистрация'; en = 'Register'; pl = 'Rejestracja';de = 'Registrierung';ro = 'Înregistrare';tr = 'Kayıt'; es_ES = 'Registro'"));
	TitleParts.Add(" ");
	TitleParts.Add(CurrentObject.RefPresentation(ObjectAsString));
	TitleParts.Add(Details);
	
	Title = New FormattedString(TitleParts);
...
Procedure EditRegistrationCompletion(Val QuestionResult, Val AdditionalParameters) Export
	...
	If Count > 0 Then
		Text = NStr("ru = 'Регистрация %1 была изменена на %2 узлах'; en = 'Registration of %1 changed at %2 nodes.'; pl = 'Rejestracja %1 została zmieniona na %2 węzłach';de = 'Registrierung von %1 wurde auf %2 Knoten geändert';ro = 'Înregistrarea %1 a fost modificată pe %2 noduri';tr = '%1ünitelerde %2 kayıtları değiştirildi'; es_ES = 'Registro de %1 se ha cambiado en los %2 nodos'");
		NotificationTitle = NStr("ru = 'Изменение регистрации:'; en = 'Registration changed:'; pl = 'Rejestracja zmian:';de = 'Registrierung ändern:';ro = 'Modifică înregistrarea:';tr = 'Kaydı değiştir:'; es_ES = 'Cambiar el registro:'");
...
Procedure SetConditionalAppearance()
	...
	Item.Appearance.SetParameterValue("Text", NStr("ru = 'ДеревоУзловОбменаНомерСообщения'; en = 'ExchangeNodesTreeMessageNumber'; pl = 'ExchangeNodesTreeMessageNumber';de = 'ExchangeNodesTreeMessageNumber';ro = 'ExchangeNodesTreeMessageNumber';tr = 'ExchangeNodesTreeMessageNumber'; es_ES = 'ExchangeNodesTreeMessageNumber'"));
