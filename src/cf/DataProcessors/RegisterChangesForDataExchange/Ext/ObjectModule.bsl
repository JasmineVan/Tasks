...
// Parameters:
	...
	CurRowNumber = 1;
	GenerateMetadataLevel(CurRowNumber, CurParameters, 1,  2,  False,   "Constants",               NStr("ru = 'Константы'; en = 'Constants'; pl = 'Stałe';de = 'Konstanten';ro = 'Constante';tr = 'Sabitler'; es_ES = 'Constantes'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 3,  4,  True, "Catalogs",             NStr("ru = 'Справочники'; en = 'Catalogs'; pl = 'Katalogi';de = 'Stammdaten';ro = 'Cataloage';tr = 'Ana kayıtlar'; es_ES = 'Catálogos'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 5,  6,  True, "Sequences",      NStr("ru = 'Последовательности'; en = 'Sequences'; pl = 'Porządkowy';de = 'Sequenzen';ro = 'Secvențe';tr = 'Sıralar'; es_ES = 'Secuencias'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 7,  8,  True, "Documents",               NStr("ru = 'Документы'; en = 'Documents'; pl = 'Dokumenty';de = 'Dokumente';ro = 'Documente';tr = 'Belgeler'; es_ES = 'Documentos'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 9,  10, True, "ChartsOfCharacteristicTypes", NStr("ru = 'Планы видов характеристик'; en = 'Charts of characteristic types'; pl = 'Plany rodzajów charakterystyk';de = 'Diagramme von charakteristischen Typen';ro = 'Diagrame de tipuri caracteristice';tr = 'Karakteristik tiplerin çizelgeleri'; es_ES = 'Diagramas de los tipos de características'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 11, 12, True, "ChartsOfAccounts",             NStr("ru = 'Планы счетов'; en = 'Charts of accounts'; pl = 'Plany kont';de = 'Kontenpläne';ro = 'Planurile conturilor';tr = 'Hesap çizelgeleri'; es_ES = 'Diagramas de las cuentas'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 13, 14, True, "ChartsOfCalculationTypes",       NStr("ru = 'Планы видов расчета'; en = 'Charts of calculation types'; pl = 'Plany typów obliczeń';de = 'Diagramme der Berechnungstypen';ro = 'Diagrame de tipuri de calcul';tr = 'Hesaplama türleri çizelgeleri'; es_ES = 'Diagramas de los tipos de cálculos'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 15, 16, True, "InformationRegisters",        NStr("ru = 'Регистры сведений'; en = 'Information registers'; pl = 'Rejestry informacji';de = 'Informationen registriert';ro = 'Registre de date';tr = 'Bilgi kayıtları'; es_ES = 'Registros de información'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 17, 18, True, "AccumulationRegisters",      NStr("ru = 'Регистры накопления'; en = 'Accumulation registers'; pl = 'Rejestry akumulacji';de = 'Akkumulationsregister';ro = 'Registre de acumulare';tr = 'Birikeçler'; es_ES = 'Registros de acumulación'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 19, 20, True, "AccountingRegisters",     NStr("ru = 'Регистры бухгалтерии'; en = 'Accounting registers'; pl = 'Rejestry księgowe';de = 'Buchhaltungsregister';ro = 'Registre contabile';tr = 'Muhasebe kayıtları'; es_ES = 'Registros de contabilidad'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 21, 22, True, "CalculationRegisters",         NStr("ru = 'Регистры расчета'; en = 'Calculation registers'; pl = 'Rejestry obliczeń';de = 'Berechnungsregister';ro = 'Registre de calcul';tr = 'Hesaplama kayıtları'; es_ES = 'Registros de cálculos'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 23, 24, True, "BusinessProcesses",          NStr("ru = 'Бизнес-процессы'; en = 'Business processes'; pl = 'Procesy biznesowe';de = 'Geschäftsprozesse';ro = 'Procesele de afaceri';tr = 'İş süreçleri'; es_ES = 'Procesos de negocio'"));
	GenerateMetadataLevel(CurRowNumber, CurParameters, 25, 26, True, "Tasks",                  NStr("ru = 'Задачи'; en = 'Tasks'; pl = 'Zadania';de = 'Aufgaben';ro = 'Sarcinile';tr = 'Görevler'; es_ES = 'Tareas'"));
...
Function ExternalDataProcessorInfo() Export
	...
	Info.Insert("Description", NStr("ru = 'Регистрация изменений для обмена данными'; en = 'Register changes for data exchange'; pl = 'Rejestracja modyfikacji do wymiany danych';de = 'Registrierung von Änderungen für den Datenaustausch';ro = 'Înregistrarea modificărilor pentru schimbul de date';tr = 'Veri alışverişi için değişikliklerin kaydı'; es_ES = 'Registro de modificaciones para el intercambio de datos'"));
	Info.Insert("Version",       "1.0");
	Info.Insert("SSLVersion",    "1.2.1.4");
	Info.Insert("Information",    NStr("ru = 'Обработка для управления регистрацией объектов на узлах обмена до формирования выгрузки. При работе в составе конфигурации с БСП версии 2.1.2.0 и старше производит контроль ограничений миграции данных для узлов обмена.'; en = 'The data processor is intended for managing registration of objects at exchange nodes before exporting data. When used in configurations with SSL version 2.1.2.0 or later, it manages data migration restrictions.'; pl = 'Przetwarzanie danych do zarządzania rejestracją obiektów na węzłach wymiany przed wygenerowaniem eksportu. Podczas korzystania z konfiguracji w wersji SL 2.1.2.0 oraz nowszej przetwarzanie danych kontroluje ograniczenia migracji danych dla węzłów wymiany.';de = 'Datenprozessor zur Verwaltung der Objektregistrierung auf Austausch-Knoten vor dem Export. Bei Verwendung der Konfiguration mit der SL-Version 2.1.2.0 und höher steuert der Datenprozessor die Datenmigrationsbeschränkungen für die Austausch-Knoten.';ro = 'Procesor de date pentru a gestiona înregistrarea obiectelor pe nodurile de schimb înainte de a genera exportul. Atunci când se utilizează configurația cu versiunea SL 2.1.2.0 și mai mare, procesorul de date controlează limitele de migrare a datelor pentru nodurile de schimb.';tr = 'Dışa aktarma işleminden önce değişim ünitelerinde nesne kaydını yönetmek için veri işlemcisi. SL  sürüm 2.1.2.0 ve üstü ile yapılandırmayı kullanırken, veri işlemcisi,  değişim üniteleri için veri geçişi sınırlamalarını kontrol eder.'; es_ES = 'Procesador de datos para gestionar el registro de objetos en los nodos de intercambio antes de generar la exportación. Utilizando la configuración con la versión SL 2.1.2.0 o superior, el procesador de datos controla las limitaciones de migración de datos para los nodos de intercambio.'"));
	...
	Command.Presentation = NStr("ru = 'Редактирование регистрации изменений объекта'; en = 'Edit object changes registration'; pl = 'Edytowanie rejestracji zmian obiektu';de = 'Bearbeiten des Objekts ändert Registrierung';ro = 'Editarea înregistrării modificărilor obiectului';tr = 'Nesne değişiklik kaydı düzenleme'; es_ES = 'Edición del registro de cambios de objetos'");
...
Function MetadataCharacteristics(MetadataTableName) Export
	...
	Result.Insert("IsReference", IsRef);
...
Function RecordSetDimensions(TableName, AllDimensions = False) Export
	...
	If Metadata.AccumulationRegisters.Contains(Meta)
	 ...
	 Or Metadata.Sequences.Contains(Meta) Then
		...
		Row.Title   = NStr("ru = 'Регистратор'; en = 'Recorder'; pl = 'Dokument';de = 'Recorder';ro = 'Registrator';tr = 'Kayıt'; es_ES = 'Registrador'");
	EndIf;
	...
	If IsInformationRegister AND Meta.MainFilterOnPeriod Then
		...
		Row.Title   = NStr("ru = 'Период'; en = 'Period'; pl = 'Okres';de = 'Zeitraum';ro = 'Perioadă';tr = 'Dönem'; es_ES = 'Período'");
	EndIf;
	...
	If Metadata.CalculationRegisters.Contains(Meta.Parent()) Then
		...
		Row.ValueType = Documents.AllRefsType();
		Row.Title   = NStr("ru = 'Объект перерасчета'; en = 'Recalculation object'; pl = 'Obiekt ponownego obliczania';de = 'Neuberechnungsobjekt';ro = 'Obiectul recalculării';tr = 'Yeniden hesaplama nesnesi'; es_ES = 'Objeto de recálculo'");
	EndIf;
...
Procedure AddColumnsToFormTable(FormTable, SaveNames, Add, Columns_Group = Undefined) Export
	...
	If Not IsDynamicList Then
		...
		For Each Column In Add Do
			CurName = Column.Name;
			If Not ToSave.Property(CurName) Then
				PermissionsToAdd.Add( New FormAttribute(CurName, Column.ValueType, TableAttributeName, Column.Title) );
			EndIf;
		EndDo;
		
		Form.ChangeAttributes(PermissionsToAdd, NamesToDelete);
	EndIf;
...
Function RefPresentation(ObjectToGetPresentation) Export
	...
	If IsBlankString(Result) Then
		Result = NStr("ru = 'не задано'; en = 'not specified'; pl = 'nie określono';de = 'nicht gesetzt';ro = 'nu este specificat';tr = 'belirlenmedi'; es_ES = 'no definido'");
	EndIf;
...
Function CheckSettingsCorrectness(SettingKey = "") Export
	...
	Else
		...
		If Metadata.DataProcessors.Find(QueryExternalDataProcessorAddressSetting) = Undefined Then
			Text = NStr("ru = 'Обработка ""%1"" не найдена в составе конфигурации'; en = 'Data processor %1is not found in the configuration'; pl = 'Opracowanie ""%1"" nie zostało znalezione w konfiguracji';de = 'Datenprozessor ""%1"" wurde in der Konfiguration nicht gefunden';ro = 'Procesarea ""%1"" nu a fost găsită în componența configurației';tr = '""%1"" veri işlemcisi yapılandırmada bulunamadı'; es_ES = 'El procesador de datos ""%1"" no se ha encontrado en la configuración'");
