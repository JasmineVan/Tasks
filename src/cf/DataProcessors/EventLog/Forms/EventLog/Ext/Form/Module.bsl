...
Procedure ExportLogForTechnicalSupport(Command)
	...
	FileSavingParameters.Dialog.Filter = NStr("ru = 'Данные журнала регистрации'; en = 'Event log data'; pl = 'Dane dziennika rejestracji';de = 'Ereignisprotokolldaten';ro = 'Datele registrului logare';tr = 'Kayıt günlüğünün verileri'; es_ES = 'Datos del registro de eventos'") + "(*.xml)|*.xml";
...
Function ReadEventLog()
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Обновление журнала регистрации'; en = 'Updating event log'; pl = 'Zaktualizuj dziennik zdarzeń';de = 'Aktualisieren Sie das Ereignisprotokoll';ro = 'Actualizați jurnalul de evenimente';tr = 'Olay günlüğünü güncelle'; es_ES = 'Actualizar el registro de eventos'");
...
Function ExportRegistrationLog()
	Return EventLogOperations.TechnicalSupportLog(EventLogFilter, EventsCountLimit, UUID);
EndFunction
