...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If Common.IsMobileClient() Then
		Items.ListToEdit.Visible = False;
	EndIf;
...
Procedure EndEdit(Command)
	...
	FileData = FilesOperationsInternalServerCall.FileData(TableRow.File);
...
Procedure DeleteFromLocalFilesCacheExecute()
	...
	QuestionText = NStr("ru = 'Удалить выбранные файлы из рабочего каталога?'; en = 'Do you want to delete the selected files from the working directory?'; pl = 'Usunąć wybrane pliki z katalogu roboczego?';de = 'Ausgewählte Dateien aus dem Arbeitsverzeichnis löschen?';ro = 'Ștergeți fișierele selectate din directorul principal?';tr = 'Seçilen dosyalar ana çalışma dizininden silinsin mi?'; es_ES = '¿Eliminar los archivos seleccionados del catálogo?'");
	...
	If ExecutionParameters.HasLockedFiles Then
		ShowMessageBox(,
			NStr("ru = 'Нельзя удалять из рабочего каталога файлы,
			           ...
			           |ro = 'Nu puteți șterge din director fișierele
			           |ocupate pentru editare.';
			           |tr = 'Düzenlenecek 
