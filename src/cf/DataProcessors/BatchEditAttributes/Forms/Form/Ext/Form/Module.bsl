...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Else
		Title = NStr("ru = 'Групповое изменение реквизитов'; en = 'Bulk attribute edit'; pl = 'Zbiorcza edycja atrybutów';de = 'Massenattributbearbeitung';ro = 'Editarea atributelor în masă';tr = 'Toplu özellik düzenleme'; es_ES = 'Edición del atributo grueso'");
...
Procedure ChoiceProcessing(SelectedValue, ChoiceSource)
	...
	If Upper(ChoiceSource.FormName) = Upper(FullFormName("AdditionalParameters")) Then
		...
		If TypeOf(SelectedValue) = Type("Structure") Then
			...
			TransactionalBatchSetting          = SelectedValue.BatchSetting;
			TransactionalPercentageOfObjectsInBatch   = SelectedValue.ObjectsPercentageInBatch;
			TransactionalNumberOfObjectsInBatch     = SelectedValue.ObjectCountInBatch;
...
Procedure OperationKindOnChange(Item)
	...
	If Object.OperationType = "ExecuteAlgorithm" Then
		...
		Items.FormChange.Title = NStr("ru = 'Выполнить'; en = 'Run'; pl = 'Wykonaj';de = 'Ausführen';ro = 'Executare';tr = 'Yürüt'; es_ES = 'Ejecutar'");
	...
	Else
		...
		Items.FormChange.Title = NStr("ru = 'Изменить реквизиты'; en = 'Edit attributes'; pl = 'Zmień atrybuty';de = 'Attribute ändern';ro = 'Schimbați atributele';tr = 'Özellikleri değiştir'; es_ES = 'Cambiar atributos'");
...
Procedure Change(Command)
	...
	If ButtonPurpose = "Change" Then
		If Not SelectedObjectsAvailable() Then
			ShowMessageBox(, NStr("ru = 'Не указаны элементы для изменения'; en = 'Items to edit are not provided.'; pl = 'Elementy do zmiany nie zostały określone';de = 'Elemente für Änderungen sind nicht angegeben';ro = 'Elementele pentru modificare nu sunt specificate';tr = 'Değişecek öğeler belirtilmedi'; es_ES = 'Artículos para cambiar no están especificados'"));
			Return;
		EndIf;
		...
		Else
			QuestionText = NStr("ru = 'Отбор не задан. Изменить все элементы?'; en = 'Filter not set. Do you want to edit all items?'; pl = 'Filtr nie jest ustawiony. Zmienić wszystkie elementy?';de = 'Filter ist nicht eingestellt. Alle Elemente ändern?';ro = 'Filtrul nu este setat. Modificați toate elementele?';tr = 'Filtre ayarlanmadı.  Tüm öğeler değişsin mi?'; es_ES = 'Filtro no está establecido. ¿Cambiar todos artículos?'");
			NotifyDescription = New NotifyDescription("ExecuteChangeFilterCheckCompleted", ThisObject);
			ShowQueryBox(NotifyDescription, QuestionText, QuestionDialogMode.OKCancel, , , NStr("ru = 'Изменение элементов'; en = 'Edit items'; pl = 'Zmień elementy';de = 'Elemente ändern';ro = 'Modificați elementele';tr = 'Öğeleri değiştir'; es_ES = 'Cambiar los artículos'"));
		EndIf;
...
Procedure ConfigureChangeParameters(Command)
	...
	FormParameters.Insert("BatchSetting",        TransactionalBatchSetting);
	FormParameters.Insert("ObjectsPercentageInBatch", TransactionalPercentageOfObjectsInBatch);
	FormParameters.Insert("ObjectCountInBatch",   TransactionalNumberOfObjectsInBatch);
...
Procedure ExecuteChangeFilterCheckCompleted(QuestionResult = Undefined, AdditionalParameters = Undefined) Export
	...
	If Not AvailableConfiguredChanges() AND Object.OperationType = "EnterValues" Then
		QuestionText = NStr("ru = 'Изменения не настроены. Выполнить перезапись элементов без изменений?'; en = 'No changes found. Do you want to save the items without changes?'; pl = 'Zmiany nie są ustawione. Przepisz te elementy bez zmian?';de = 'Änderungen sind nicht festgelegt. Schreiben Sie die Elemente ohne Änderungen neu?';ro = 'Modificările nu sunt setate. Rescrieți elementele fără modificări?';tr = 'Değişiklikler ayarlanmadı.  Öğeler değişiklik olmadan tekrar yazılsın mı?'; es_ES = 'Cambios no están establecidos. ¿Volver a grabar los artículos sin cambiar?'");
...
Procedure ExecuteActionsOnContextOpen()
	...
	CaptionPattern = NStr("ru = 'Изменение выделенных элементов ""%1"" (%2)'; en = 'Edit selected %1 items (%2)'; pl = 'Zmień wybrane elementy ""%1"" (%2)';de = 'Ändern Sie die ausgewählten Elemente ""%1"" (%2)';ro = 'Modificați elementele selectate ""%1"" (%2)';tr = 'Seçilmiş öğeleri seçin ""%1"" (%2)'; es_ES = 'Cambiar los artículos seleccionado ""%1"" (%2)'");
	...
	If ObjectsTypes.Count() > 1 Then
		TypePresentation = "";
		CaptionPattern = NStr("ru = 'Изменение выделенных элементов (%2)'; en = 'Edit selected items (%2)'; pl = 'Zmień wybrane elementy (%2)';de = 'Ändern der ausgewählten Elemente (%2)';ro = 'Modificarea elementelor selectate (%2)';tr = 'Seçilmiş öğeleri değiştir (%2)'; es_ES = 'Cambiar los elementos seleccionados (%2)'");
	EndIf;
	
	ObjectsCount = Parameters.ObjectsArray.Count();
	Title = SubstituteParametersToString(CaptionPattern, TypePresentation, ObjectsCount);
...
Procedure QuestionGoToUnlockAttributes(SelectedAttribute)
	...
	If ContextCall Then
		Buttons.Add(DialogReturnCode.Yes, NStr("ru = 'Перейти'; en = 'Navigate'; pl = 'Przejdź';de = 'Navigieren';ro = 'Navigare';tr = 'Geçiş yapın'; es_ES = 'Navegar'"));
		QuestionText = NStr("ru = 'Реквизит заблокирован, перейти к разблокированию реквизитов?'; en = 'The attribute has been locked. Unlock attribute?'; pl = 'Atrybut został zablokowany. Odblokować atrybuty?';de = 'Das Attribut wurde gesperrt. Attribute freischalten?';ro = 'Atributul a fost blocat. Deblocați atributele?';tr = 'Özellik kilitlendi. Özelliklerin kilidini açılsın mı?'; es_ES = 'El atributo se ha bloqueado. ¿Desbloquear los atributos?'");
	Else
		Buttons.Add(DialogReturnCode.Yes, NStr("ru = 'Разблокировать'; en = 'Unlock'; pl = 'Odblokuj';de = 'Entsperren';ro = 'Deblocare';tr = 'Kilidi kaldır'; es_ES = 'Desbloquear'"));
		QuestionText = SubstituteParametersToString(
			NStr("ru = 'Для того чтобы не допустить рассогласования данных в программе,
				...
				|prin verificarea tuturor locurilor de utilizare a elementelor selectate din aplicație.
				|
				|Deblocați atributul ""%1"" pentru modificare?';
...
" öğesinin tüm kullanım yerlerini  kontrol ederek sonuçların değerlendirilmesi önerilir. 
	...
	ShowQueryBox(NotifyDescription, QuestionText, Buttons, , DialogReturnCode.Yes, NStr("ru = 'Реквизит заблокирован'; en = 'Attribute is locked'; pl = 'Rekwizyt jest zablokowany';de = 'Attribut ist gesperrt';ro = 'Atributul este blocat';tr = 'Özellik kilitlendi'; es_ES = 'Atributo está bloqueado'"));
...
Procedure AllowEditAttributes(SelectedAttribute)
	...
	Else
		...
		For Each OperationDescriptionString In LockedAttributesRows Do
			AttributesSynonyms.Add(OperationDescriptionString.Presentation);
		EndDo;
...
Procedure SettButtonsDuringChange(StartChange)
	...
	If StartChange Then
		Items.FormChange.Title = NStr("ru = 'Прервать'; en = 'Abort'; pl = 'Przerwij';de = 'Abbrechen';ro = 'Renunțați';tr = 'Durdur'; es_ES = 'Anular'");
	Else
		If ObjectsThatCouldNotBeChanged.Count() > 0 Then
			Items.FormChange.Title = NStr("ru = 'Повторить изменение'; en = 'Edit same attributes'; pl = 'Zmień ponownie';de = 'Ändern Sie erneut';ro = 'Schimbați din nou';tr = 'Tekrar değiştir'; es_ES = 'Cambiar de nuevo'");
		Else
			Items.FormChange.Title = NStr("ru = 'Закрыть'; en = 'Close'; pl = 'Zamknij';de = 'Schließen';ro = 'Închideți';tr = 'Kapat'; es_ES = 'Cerrar'");
		EndIf;
	EndIf;
...
Procedure ChangeObjects()
	...
	If Object.ChangeInTransaction Then
		...
		If TransactionalBatchSetting = 1 Then // Processing in one call.
			...
			ShowUserNotification(NStr("ru = 'Изменение выделенных элементов'; en = 'Edit selected items'; pl = 'Zmień wybrane elementy';de = 'Ändern Sie ausgewählte Artikel';ro = 'Modificați elementele selectate';tr = 'Seçilmiş öğeleri değiştir'; es_ES = 'Cambiar los artículos seleccionados'"), ,NStr("ru = 'Пожалуйста подождите, обработка может занять некоторое время...'; en = 'Please wait. Processing may take some time...'; pl = 'Proszę czekać. Przetwarzanie danych może zająć trochę czasu...';de = 'Bitte warten. Der Datenprozessor kann einige Zeit benötigen...';ro = 'Așteptați. Procesorul de date poate dura ceva timp ...';tr = 'Lütfen bekle. Veri işlemcisi biraz zaman alabilir ...'; es_ES = 'Por favor, espere. Procesador de datos puede llevar algún tiempo...'"));
	...
	Else
		...
		Status(NStr("ru = 'Обрабатываются элементы...'; en = 'Processing in progress...'; pl = 'Przetwarzanie elementów...';de = 'Elemente bearbeiten...';ro = 'Procesarea articolelor ...';tr = 'Öğeler işleniyor...'; es_ES = 'Procesando artículos...'"), 0, NStr("ru = 'Изменение выделенных элементов'; en = 'Edit selected items'; pl = 'Zmień wybrane elementy';de = 'Ändern Sie ausgewählte Artikel';ro = 'Modificați elementele selectate';tr = 'Seçilmiş öğeleri değiştir'; es_ES = 'Cambiar los artículos seleccionados'"));
...
Procedure ProcessChangeResult(ChangeResult = Undefined, ContinueProcessing = Undefined)
	...
	While ContinueProcessing Do
		...
		QuestionText = NStr("ru = 'При изменении элементов (группы элементов) возникли ошибки.
			...
			|ro = 'Erori la modificarea elementelor (grupului de elemente).
			|Întrerupeți modificarea elementelor și treceți la vizualizarea erorilor?';
		...
		Buttons = New ValueList;
		Buttons.Add(DialogReturnCode.Abort, NStr("ru = 'Прервать'; en = 'Cancel'; pl = 'Przerwij';de = 'Abbrechen';ro = 'Renunțați';tr = 'Durdur'; es_ES = 'Anular'"));
		Buttons.Add(DialogReturnCode.Ignore, NStr("ru = 'Продолжить'; en = 'Continue'; pl = 'Kontynuuj';de = 'Weiter';ro = 'Continuare';tr = 'Devam'; es_ES = 'Continuar'"));
		Buttons.Add(DialogReturnCode.No, NStr("ru = 'Больше не спрашивать'; en = 'Do not ask again'; pl = 'Nie pytaj ponownie';de = 'Nicht mehr fragen';ro = 'Nu mai întreba';tr = 'Tekrar sorma'; es_ES = 'No preguntar más'"));
		
		NotifyDescription = New NotifyDescription("ProcessChangeResultResponseReceived", ThisObject, ChangeResult);
		ShowQueryBox(NotifyDescription, QuestionText, Buttons, , DialogReturnCode.Abort, NStr("ru = 'Ошибки при изменении элементов'; en = 'Editing errors'; pl = 'Wystąpiły błędy podczas zmiany elementów';de = 'Beim Ändern von Elementen sind Fehler aufgetreten';ro = 'Au apărut erori la schimbarea elementelor';tr = 'Öğeler değiştirildiğinde hatalar oluştu'; es_ES = 'Errores ocurridos al cambiar los artículos'"));
		Return;
	EndDo;
	...
	If CurrentChangeStatus.ShowProcessedItemsPercentage Then
		...
		Status(NStr("ru = 'Обрабатываются элементы...'; en = 'Processing in progress...'; pl = 'Przetwarzanie elementów...';de = 'Elemente bearbeiten...';ro = 'Procesarea articolelor ...';tr = 'Öğeler işleniyor...'; es_ES = 'Procesando artículos...'"), CurrentPercentage, NStr("ru = 'Изменение выделенных элементов'; en = 'Edit selected items'; pl = 'Zmień wybrane elementy';de = 'Ändern Sie ausgewählte Artikel';ro = 'Modificați elementele selectate';tr = 'Seçilmiş öğeleri değiştir'; es_ES = 'Cambiar los artículos seleccionados'"));
	EndIf;
...
Procedure CompleteObjectChange()
	...
	If ProcessingCompleted Then
		ShowUserNotification(NStr("ru = 'Изменение реквизитов элементов'; en = 'Edit attributes'; pl = 'Zmień atrybuty elementów';de = 'Ändern Sie die Elementattribute';ro = 'Modificați atributele elementului';tr = 'Öğe özelliklerini değiştir'; es_ES = 'Cambiar los atributos del artículo'"), , 
			SubstituteParametersToString(NStr("ru = 'Изменены элементы (%1).'; en = '%1 items have been edited.'; pl = 'Elementy zostały zmienione (%1).';de = 'Elemente werden geändert (%1).';ro = 'Elementele sunt modificate (%1).';tr = 'Öğeler değiştirildi (%1)'; es_ES = 'Artículos se han cambiado (%1).'"), CurrentChangeStatus.ChangedCount));
		GoToCompletedPage();
		Return;
	EndIf;
	...
	If ProcessingCompleted Then
		MessageTemplate = NStr("ru = 'Изменения выполнены во всех выбранных элементах (%2).'; en = 'All %2 selected items have been edited.'; pl = 'Zmiany są wprowadzane we wszystkich wybranych elementach (%2).';de = 'Änderungen werden an allen ausgewählten Elementen vorgenommen (%2).';ro = 'Modificările sunt efectuate în toate elementele selectate (%2).';tr = 'Seçilen tüm öğelerde (%2) değişiklikler yapıldı.'; es_ES = 'Cambios se han hecho en todos los artículos seleccionados (%2).'");
	Else
		If Object.ChangeInTransaction Or CurrentChangeStatus.ChangedCount = 0 Then
			MessageTemplate = NStr("ru = 'Изменения не выполнены.'; en = 'No items have been edited.'; pl = 'Nie zmieniony.';de = 'Nicht geändert.';ro = 'Neschimbat.';tr = 'Değiştirildi.'; es_ES = 'No cambiado.'");
		Else
			MessageTemplate = NStr("ru = 'Изменения выполнены частично.
										...
										|ro = 'Parțial modificat.
										|Modificat: %1; Nu sa reușit modificarea: %3';
	...
	If Object.ChangeInTransaction AND Not ProcessingCompleted Then
		...
		If SkippedItemsCount > 0 AND Not CurrentChangeStatus.AbortChange Then
			...
			TableRow.Object = SubstituteParametersToString(NStr("ru = '... и другие элементы (%1)'; en = '... and other items (%1)'; pl = '... i inne elementy (%1)';de = '... und andere Elemente (%1)';ro = '... și alte elemente (%1)';tr = '...ve diğer öğeler (%1)'; es_ES = '... y otros artículos (%1)'"), SkippedItemsCount);
			TableRow.Reason = NStr("ru = 'Пропущены, так как не были изменены один или более элементов.'; en = 'Skipped as one or more items could not be edited.'; pl = 'Pominięte, ponieważ jeden lub więcej elementów nie zostało zmieniono.';de = 'Übersprungen, wenn ein oder mehrere Elemente nicht geändert wurden.';ro = 'Omise deoarece unul sau mai multe elemente nu au fost modificate.';tr = 'Bir veya daha fazla öğe değişmemiş olarak atlandı.'; es_ES = 'Saltado, porque uno o más artículos no se ha cambiado.'");
		EndIf;
	EndIf;
...
Procedure BackServer()
	...
	If Object.OperationType = "ExecuteAlgorithm" Then
		Items.FormChange.Title = NStr("ru = 'Выполнить'; en = 'Run'; pl = 'Wykonaj';de = 'Ausführen';ro = 'Executare';tr = 'Yürüt'; es_ES = 'Ejecutar'");
		Items.FormChange.ExtendedTooltip.Title = NStr("ru = 'Выполнить алгоритм'; en = 'Run algorithm'; pl = 'Uruchom algorytm';de = 'Ausführen des Algorithmus';ro = 'Executare algoritmul';tr = 'Algoritmayı yap'; es_ES = 'Realizar el algoritmo'");
	Else
		Items.FormChange.Title = NStr("ru = 'Изменить реквизиты'; en = 'Edit attributes'; pl = 'Zmień atrybuty';de = 'Attribute ändern';ro = 'Schimbați atributele';tr = 'Özellikleri değiştir'; es_ES = 'Cambiar atributos'");
	EndIf;
...
Procedure GoToCompletedPage()
	...
	Items.DoneLabel.Title = SubstituteParametersToString(
		NStr("ru = 'Реквизиты выбранных элементов были изменены.
			...
			|Insgesamt geänderte Elemente:%1';
			|ro = 'Atributele elementelor selectate au fost modificate.
			|Total elemente modificate: %1';
			...
			|Total de artículos modificados:%1'"), CurrentChangeStatus.ChangedCount);
	Items.FormChange.Title = NStr("ru = 'Готово'; en = 'Finish'; pl = 'Koniec';de = 'Abschluss';ro = 'Sfârșit';tr = 'Bitiş'; es_ES = 'Finalizar'");
	Items.FormBack.Visible = True;
...
Procedure ChangeAtServer(Val StopChangeOnError)
	...
	Else
		...
		ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Групповое изменение элементов'; en = 'Bulk item edit'; pl = 'Zbiorcza edycja elementów';de = 'Massenbearbeitung von Elementen';ro = 'Editarea în masă a elementelor';tr = 'Toplu grup değişiklikleri'; es_ES = 'Edición masiva de artículos'");
...
Function SelectedObjects(FilterSettings = Undefined, ErrorMessageText = "")
	...
	UpdateList = FilterSettings.UpdateList;
...
Function SelectedObjectsCount(Recalculate = False, ForChange = False, ErrorMessageText = "")
	FilterSettings = FilterSettings();
	FilterSettings.UpdateList = Recalculate;
...
Procedure GenerateNoteAboutAutonumbering()
	...
	ElsIf Autonumbering Then
		NoteOnAutonumbering = NStr("ru = '<Установить автоматически>'; en = '<Set automatically>'; pl = '<Zainstaluj automatycznie>';de = '<Automatisch installieren>';ro = '<Setare automat>';tr = '<Otomatik olarak yap>'; es_ES = '<Instalar automáticamente>'");
	Else
		NoteOnAutonumbering = NStr("ru = '<Очистить>'; en = '<Clear>'; pl = '<Wyczyść>';de = '<Reinigen>';ro = '<Golire>';tr = '<Temizle>'; es_ES = '<Limpiar>'");
	EndIf;
...
Function AttributesTableColumnDescriptions()
	...
	ColumnDetails.Type = New TypeDescription("String");
	ColumnDetails.Presentation = NStr("ru = 'Реквизит'; en = 'Attribute'; pl = 'Rekwizyt';de = 'Attribut';ro = 'Atribute';tr = 'Özellik'; es_ES = 'Atributo'");
	...
	ColumnDetails.Presentation = NStr("ru = 'Новое значение'; en = 'New value'; pl = 'Nowa wartość';de = 'Neuer Wert';ro = 'Noua valoare';tr = 'Yeni değer'; es_ES = 'Nuevo valor'");
	ColumnDetails.FieldKind = FormFieldType.InputField;
...
Procedure AddAdditionalAttributesAndInfoToSet()
	...
	If ContextCall Then
		FilterSettings = FilterSettings();
		FilterSettings.UpdateList = True;
...
Procedure AddPropertyToAttributesList(Property)
	PropertyDetails = ObjectAttributesValues(Property, "Ref,Description,ValueType,IsAdditionalInfo");
...
Procedure GenerateNoteOnConfiguredChanges()
	...
	If AttributesToChange.Count() = 1 Then
		Note = NStr("ru = 'реквизит'; en = 'attribute'; pl = 'atrybut';de = 'Requisit';ro = 'atributul';tr = 'özellik'; es_ES = 'requisito'") + " " + Note;
	ElsIf AttributesToChange.Count() > 1 Then
		Note = NStr("ru = 'реквизиты'; en = 'attributes'; pl = 'atrybuty';de = 'Requisiten';ro = 'atribute';tr = 'özellikler'; es_ES = 'atributos'") + " " + Note;
	EndIf;
	
	If Not IsBlankString(Note) Then
		Note = Note + " " + NStr("ru = 'в выбранных элементах'; en = 'in selected items'; pl = 'w wybranych pozycjach';de = 'in den ausgewählten Elementen';ro = 'în elementele selectate';tr = 'seçilmiş öğelerde'; es_ES = 'en los elementos seleccionados'");
	EndIf;
	...
	For Each TabularSection In TabularSectionsToChange Do
		...
		If AttributesToChange.Count() > 3 Then
			If Not IsBlankString(Note) Then
				Note = Note + ", ";
			EndIf;
			Note = Note + SubstituteParametersToString(NStr("ru = 'реквизиты (%1)'; en = 'attributes (%1)'; pl = 'szczegóły (%1)';de = 'Requisiten (%1)';ro = 'atribute (%1)';tr = 'özellikler (%1)'; es_ES = 'requisitos (%1)'"), AttributesToChange.Count());
		Else
			For Each Attribute In AttributesToChange Do
				If Not IsBlankString(Note) Then
					Note = Note + ", ";
				...
				If AttributesToChange.Find(Attribute) = 0 Then
					If AttributesToChange.Count() = 1 Then
						Note = Note + NStr("ru = 'реквизит'; en = 'attribute'; pl = 'atrybut';de = 'Requisit';ro = 'atributul';tr = 'özellik'; es_ES = 'requisito'") + " ";
					ElsIf AttributesToChange.Count() > 1 Then
						Note =  Note + NStr("ru = 'реквизиты'; en = 'attributes'; pl = 'atrybuty';de = 'Requisiten';ro = 'atribute';tr = 'özellikler'; es_ES = 'atributos'") + " ";
					EndIf;
				EndIf;
				Note = Note + """" + Attribute + """";
			EndDo;
		EndIf;
		Note = Note + " " 
			+ SubstituteParametersToString(NStr("ru = 'в табличной части ""%1""'; en = 'in %1 tabular section'; pl = 'w części tabelarycznej ""%1""';de = 'im tabellarischen Teil ""%1""';ro = 'în secțiunea tabelară ""%1""';tr = 'tablo bölümünde ""%1""'; es_ES = 'en la parte de tabla ""%1""'"), TabularSection.Key);
	EndDo;
	
	If Not IsBlankString(Note) Then
		If TabularSectionsToChange.Count() > 0 Then
			If FilterByRowsAvailable Then 
				Note = Note + " " + NStr("ru = 'в тех строках выбранных элементов, которые удовлетворяют условиям отбора'; en = 'only in strings of selected items that match filter criteria'; pl = 'w tych wierszach wybranych pozycji, które spełniają warunki selekcji';de = 'in den Zeilen der ausgewählten Elemente, die den Auswahlbedingungen entsprechen';ro = 'în acele rânduri ale elementelor selectate, care satisfac condițiile de filtrare';tr = 'filtre koşullarını karşılayan seçilmiş öğelerin satırlarında'; es_ES = 'en las líneas de los elementos seleccionados que cumplen las condiciones de la selección'")
			Else
				Note = Note + " " + NStr("ru = '<b>во всех строках</b> выбранных элементов'; en = '<b>in all strings</b> of selected items'; pl = '<b>we wszystkich wierszach</b> wybranych elementów';de = '<b>in allen Zeilen der</b> ausgewählten Elemente';ro = '<b>în toate rândurile</b> elementelor selectate';tr = '<b>seçilmiş </b>öğelerin tüm satırlarında'; es_ES = '<b>en todas las líneas</b> de los elementos seleccionados'")
			EndIf;
		EndIf;
	EndIf;
	...
	If SelectedObjectsAvailable() Then
		If Not IsBlankString(Note) Then
			Note = NStr("ru = 'Изменить'; en = 'Edit'; pl = 'Zmień';de = 'Ändern';ro = 'Modificați';tr = 'Değiştir'; es_ES = 'Cambiar'") + " " + Note + ".";
		Else
			Note = NStr("ru = 'Выполнить <b>перезапись</b> выбранных элементов.'; en = '<b>Rewrite</b> selected items.'; pl = 'Wykonaj <b> ponowne zapisywanie </b> wybranych elementów.';de = '<b>Überschreibe</b>Sie die ausgewählten Elemente.';ro = 'Execută <b>reînregistrarea</b> elementelor selectate.';tr = '<b>Seçilmiş öğeler</b>yeniden yazılsın.'; es_ES = 'Realizar <b>la regrabación</b> de los elementos guardados.'");
		EndIf;
	Else
		Note = NStr("ru = 'Не выбраны элементы, реквизиты которых необходимо изменить.'; en = 'No items selected.'; pl = 'Elementy, których atrybuty zostaną zmienione, nie są wybierane.';de = 'Elemente, deren Attribute geändert werden sollen, werden nicht ausgewählt.';ro = 'Elementele cu atribute ce se modifică nu vor fi selectate.';tr = 'Niteliklerin değiştirileceği öğeler seçilmez.'; es_ES = 'Artículos cuyos atributos tienen que cambiarse, no se han seleccionado.'");
	EndIf;
...
Procedure UpdateSelectedCountLabel()
	...
	If AvailableConfiguredFilters() Then
		...
		LabelText = StringWithNumberForAnyLanguage(NStr("ru = ';%1 элемент;;%1 элемента;%1 элементов;%1 элемента'; en = ';%1 item;;%1 items;%1 items;%1 items'; pl = ';%1 element;;%1 elementu;%1 elementów;%1 elementu';de = ';%1 Element ;;%1 Element;%1 Elemente;%1 Element';ro = ';%1 element;;%1 elemente;%1 elemente;%1 elemente';tr = ';%1 öğe;;%1 öğe;%1 öğe;%1 öğe'; es_ES = ';%1 elemento;;%1 del elemento;%1 de los elementos;%1 del elemento'"),
			SelectedObjectsCount);
	Else
		LabelText = NStr("ru = 'Все элементы'; en = 'All items'; pl = 'Wszystkie elementy';de = 'Alle Elemente';ro = 'Toate obiectele';tr = 'Tüm öğeler'; es_ES = 'Todos los artículos'");
	EndIf;
...
Procedure SetChangeSetting(Val Setting)
	...
	If LockedAttributesAvailable Then
		ShowMessageBox(, NStr("ru = 'Некоторые реквизиты заблокированы для изменения, изменения не установлены.'; en = 'Some attributes are locked for editing. Changes are not saved.'; pl = 'Niektóre rekwizyty są zablokowane do edycji. Zmiany nie zostały zdefiniowane.';de = 'Einige Attribute sind zur Bearbeitung gesperrt. Änderungen wurden nicht definiert.';ro = 'Unele atribute sunt blocate pentru editare. Modificările nu au fost definite.';tr = 'Bazı özellikler düzenleme için kilitlenmiştir. Değişiklikler tanımlanmamıştır.'; es_ES = 'Algunos atributos están bloqueados para edición. Cambios no se han definido.'"));
	EndIf;
...
Function ChoiceParameterLinksPresentation(ChoiceParameterLinks, MetadataObject)
	...
	For Each ChoiceParameterLinkDescription In ChoiceParameterLinks Do
		...
		If AttributesOwner <> Undefined Then
			...
			If Attribute = Undefined Then
				For Each StandardAttribute In AttributesOwner.StandardAttributes Do
			...
			If Attribute <> Undefined Then
				...
				If Not IsBlankString(TabularSectionPresentation) Then
					AttributePresentation = AttributePresentation + " (" + NStr("ru = 'таблица'; en = 'table'; pl = 'tabela';de = 'tabelle';ro = 'tabel';tr = 'tablo'; es_ES = 'tabla'") + " " 
						+ TabularSectionPresentation + ")";
				EndIf;
	...
	If LinkedAttributes.Count() > 0 Then
		LinkPresentationPattern = NStr("ru = 'Зависит от реквизитов: %1.'; en = 'Dependency to attributes: %1.'; pl = 'Zależy od szczegółów: %1.';de = 'Hängt von den Requisiten ab: %1.';ro = 'Depinde de atributele: %1.';tr = 'Özelliklere bağlı: %1.'; es_ES = 'Depende de los requisitos: %1.'");
		If LinkedAttributes.Count() = 1 Then
			LinkPresentationPattern = NStr("ru = 'Зависит от реквизита %1.'; en = 'Depends on attribute %1.'; pl = 'Zależy od szczegółu %1.';de = 'Hängt von dem Requisit ab: %1.';ro = 'Depinde de atributul %1.';tr = 'Özelliğe bağlı %1.'; es_ES = 'Depende del requisito %1.'");
		EndIf;
...
Function ComposerParameters(Formula)
	...
	Result.Insert("OperandsTitle", NStr("ru = 'Доступные реквизиты'; en = 'Available attributes'; pl = 'Dostępne atrybuty';de = 'Verfügbare Requisiten';ro = 'Atribute disponibile';tr = 'Mevcut özellikler'; es_ES = 'Requisitos disponibles'"));
...
Function ObjectManagerByFullName(FullName)
	...
	ElsIf Upper(MOClass) = "CALCULATIONREGISTER" Then
		...
		Else
			...
			Else
				Raise SubstituteParametersToString(NStr("ru = 'Неизвестный тип объекта метаданных ""%1""'; en = 'Invalid metadata object type: %1.'; pl = 'Nieznany typ obiektu metadanych %1';de = 'Unbekannter Metadaten-Objekttyp ""%1""';ro = 'Tip necunoscut al obiectului de metadate ""%1""';tr = 'Bilinmeyen meta veri nesne türü ""%1""'; es_ES = 'Tipo del objeto de metadatos desconocido ""%1""'"), FullName);
			EndIf;
		EndIf;
...
Function ObjectAttributesValues(Ref, Val Attributes)
	...
	ElsIf TypeOf(Attributes) = Type("Array") Or TypeOf(Attributes) = Type("FixedArray") Then
		...
		EndDo;
	Else
		Raise SubstituteParametersToString(NStr("ru = 'Неверный тип второго параметра Реквизиты: %1'; en = 'Invalid Attributes parameter type: %1'; pl = 'Nieprawidłowy typ parametru Atrybuty: %1';de = 'Ungültiger Parametertyp für Attribute: %1';ro = 'Tip de parametru atribute nevalide: %1';tr = 'Geçersiz Özellikler parametresinin türü: %1'; es_ES = 'Tipo del parámetro de Atributos inválido: %1'"), String(TypeOf(Attributes)));
	EndIf;
...
#If Server Or ThickClientOrdinaryApplication Or ExternalConnection Then
	...
	If TypeOf(Module) <> Type("CommonModule") Then
		Raise SubstituteParametersToString(NStr("ru = 'Общий модуль ""%1"" не найден.'; en = 'Cannot find common module %1.'; pl = 'Nie znaleziono wspólnego modułu ""%1"".';de = 'Gemeinsames Modul ""%1"" wurde nicht gefunden.';ro = 'Modulul comun ""%1"" nu a fost găsit.';tr = 'Ortak modül ""%1"" bulunamadı.'; es_ES = 'Módulo común ""%1"" no se ha encontrado.'"), Name);
	EndIf;
#Else
	Module = Eval(Name);
	If TypeOf(Module) <> Type("CommonModule") Then
...
Function ReadXMLToTable(Val XML)
	...
	If Not Read.Read() Then
		Raise NStr("ru = 'Пустой XML'; en = 'XML file is empty.'; pl = 'Pusty XML';de = 'Leeres XML';ro = 'XML gol';tr = 'Boş XML'; es_ES = 'XML vacío'");
...
&AtClient
Procedure PresentationOfObjectsToChangeAutoSelection(Item, Text, ChoiceData, DataGetParameters, Waiting, StandardProcessing)
	InputFieldAutoSelection(Item, Text, ChoiceData, DataGetParameters, Waiting, StandardProcessing)
EndProcedure

&AtClient
Procedure InputFieldAutoSelection(Item, Text, ChoiceData, DataGetParameters, Wait, StandardProcessing)
...
Function ChoiceData(String, ChoiceList)
	...
	For Each Item In ChoiceList Do
		...
		For Each Substring In StrSplit(String, " ", False) Do
			...
			FormattedStrings.Add(New FormattedString(OccurenceSubstring, New Font( , , True), New Color(0,128,0)));
		EndDo;
