...
&AtClient
Procedure SettingsComposerSettingsFilterBeforeAddRow(Item, Cancel, Clone, Parent, Folder)
...
Procedure UpdateSelectedListAtServer()
	...
	If SelectedCount > 1000 Then
		SelectedCount = NStr("ru = '> 1000'; en = '> 1000'; pl = '> 1000';de = '> 1000';ro = '> 1000';tr = '> 1000'; es_ES = '> 1000'");
	ElsIf SelectedCount = 0 Then
		List.SettingsComposer.Refresh(DataCompositionSettingsRefreshMethod.Full);
	EndIf;
	Items.SelectedObjectsGroup.Title = SubstituteParametersToString(NStr("ru = 'Выбранные элементы (%1)'; en = 'Selected items (%1)'; pl = 'Wybrane elementy (%1)';de = 'Ausgewählte Elemente (%1)';ro = 'Elementele selectate (%1)';tr = 'Seçilmiş öğeler (%1)'; es_ES = 'Elementos seleccionados (%1)'"), SelectedCount);
