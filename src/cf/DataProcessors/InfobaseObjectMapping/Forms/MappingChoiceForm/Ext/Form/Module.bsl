...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	Items.ObjectToMap.Title = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru='Объект в ""%1""'; en = 'Object in ""%1""'; pl = 'Obiekt w ""%1""';de = 'Objekt in ""%1""';ro = 'Obiect în  ""%1""';tr = '""%1"" ''deki nesne'; es_ES = 'Objeto en ""%1""'"), Parameters.Application1);
		
	Items.Header.Title = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru='Объект в ""%1""'; en = 'Object in ""%1""'; pl = 'Obiekt w ""%1""';de = 'Objekt in ""%1""';ro = 'Obiect în  ""%1""';tr = '""%1"" ''deki nesne'; es_ES = 'Objeto en ""%1""'"), Parameters.Application2);
...
Procedure GenerateChoiceTable(Val FieldsTotal, Val UsedFields, Val DataAddress)
	...
	For FieldNumber=1 To FieldsTotal Do
		PermissionsToAdd.Add(New FormAttribute("SortField" + Format(FieldNumber, "NZ=; NG="), StringType, "ChoiceTable"));
	EndDo;
	ChangeAttributes(PermissionsToAdd);
	...
	For FieldNumber=0 To FieldsTotal-1 Do
		Attribute = PermissionsToAdd[FieldNumber];
