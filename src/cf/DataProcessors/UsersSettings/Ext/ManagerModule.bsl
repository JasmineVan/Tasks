...
Function AllFormSettings(Username)
	...
	FormsList.Add("ExternalDataProcessor.StandardEventLog.Form.EventsJournal", 
		NStr("ru = 'Стандартные.Журнал регистрации'; en = 'Standard.Event log'; pl = 'Standardowe.Dziennik zdarzeń';de = 'Standard.Ereignisprotokoll';ro = 'Standard. Eveniment log';tr = 'Standart. Olay günlüğü'; es_ES = 'Estándar.Registro de eventos'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardEventLog.Form.EventForm", 
		NStr("ru = 'Стандартные.Журнал регистрации, Событие'; en = 'Standard.Event log, Event'; pl = 'Standardowe.Dziennik zdarzeń, Zdarzenia';de = 'Standard.Ereignisprotokoll, Ereignis';ro = 'Standard. Eveniment log, Eveniment';tr = 'Standart. Olay günlüğü, Olay'; es_ES = 'Estándar.Registro de eventos, Evento'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardEventLog.Form.EventsJournalFilter", 
		NStr("ru = 'Стандартные.Журнал регистрации, Настройка отбора событий'; en = 'Standard.Event log, Event filter settings'; pl = 'Standardowe.Dziennik zdarzeń, Dostosuj wybór zdarzenia';de = 'Standard.Ereignisprotokoll, Anpassen der Ereignisauswahl';ro = 'Standard.Registrul logare, Setarea filtrului evenimentelor';tr = 'Standart. Olay günlüğü, Olay seçimini özelleştir'; es_ES = 'Estándar.Registro de eventos, Personalizar la selección de eventos'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardFindByRef.Form.MainForm", 
		NStr("ru = 'Стандартные.Поиск ссылок на объект'; en = 'Standard.Find references to objects'; pl = 'Standardowe.Wyszukaj linki do obiektu';de = 'Standard.Suchen Sie nach Links zum Objekt';ro = 'Standard.Căutarea referințelor la obiect';tr = 'Standart. Nesne bağlantılarını ara'; es_ES = 'Estándar.Buscar los enlaces a objetos'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardFullTextSearchManagement.Form.MainForm", 
		NStr("ru = 'Стандартные.Управление полнотекстовым поиском'; en = 'Standard.Manage Full Text Search'; pl = 'Standardowe.Kierowanie wyszukiwaniem tekstowym';de = 'Standard.Verwalte Volltextsuche';ro = 'Standard.Administrarea căutării full-text';tr = 'Standart. Tam metin aramayı yönet'; es_ES = 'Estándar.Gestionar la búsqueda de texto completo'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardDocumentsPosting.Form.MainForm", 
		NStr("ru = 'Стандартные.Проведение документов'; en = 'Standard.Document Posting'; pl = 'Standardowe.Publikowanie dokumentów';de = 'Standard.Dokument Buchung';ro = 'Standard.Validarea documentelor';tr = 'Standart.  Belgenin onayı'; es_ES = 'Estándar.Envío de documentos'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardDeleteMarkedObjects.Form.Form", 
		NStr("ru = 'Стандартные.Удаление помеченных объектов'; en = 'Standard.Delete Marked Objects'; pl = 'Standardowe.Usuń wybrane obiekty';de = 'Standard.Löschen ausgewählter Objekte';ro = 'Standard.Ștergerea obiectelor marcate';tr = 'Standart.  Seçilmiş nesnelerin silinmesi'; es_ES = 'Estándar.Borrar los objetos seleccionados'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardExternalDataSourceManagement.Form.Form", 
		NStr("ru = 'Стандартные.Управление внешними источниками данных'; en = 'Standard.Management of external data sources'; pl = 'Standardowe.Zarządzaj zewnętrznymi źródłami danych';de = 'Standard.Verwalte externe Datenquellen';ro = 'Standard.Administrarea surselor de date externe';tr = 'Standart. Harici veri kaynaklarını yönet'; es_ES = 'Estándar.Gestionar las fuentes de datos externos'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardTotalsManagement.Form.MainForm", 
		NStr("ru = 'Стандартные.Управление итогами'; en = 'Standard.Totals management'; pl = 'Standardowe.Zarządzanie całkowite';de = 'Standard.Gesamtverwaltung';ro = 'Standard.Administrarea totalurilor';tr = 'Standart.  Toplamlar yönetimi'; es_ES = 'Estándar.Gestión total'") , False, PictureLib.Form);
	FormsList.Add("ExternalDataProcessor.StandardActiveUsers.Form.ActiveUsersListForm", 
		NStr("ru = 'Стандартные.Активные пользователи'; en = 'Standard.Active users'; pl = 'Standardowe.Aktywni użytkownicy';de = 'Standard.Aktive Benutzer';ro = 'Standard. Utilizatori activi';tr = 'Standart.  Aktif kullanıcılar'; es_ES = 'Estándar.Usuarios activos'") , False, PictureLib.Form);
...
Function MetadataObjectForms()
	...
	FillMetadataObjectForms(Metadata.FilterCriteria, "FilterCriterion", NStr("ru = 'Критерий отбора'; en = 'Filter criterion'; pl = 'Kryterium filtrowania';de = 'Filterkriterium';ro = 'Criteriu de filtrare';tr = 'Filtre kriteri'; es_ES = 'Criterio del filtro'"),
		StandardFormNames, PictureLib.FilterCriterion, FormsList);
		
	StandardFormNames = New ValueList;
	FillMetadataObjectForms(Metadata.SettingsStorages, "SettingsStorage", NStr("ru = 'Хранилище настроек'; en = 'Settings storage'; pl = 'Przechowywania ustawień';de = 'Speicherung der Einstellungen';ro = 'Setări de stocare';tr = 'Ayarlar depolama alanı'; es_ES = 'Almacenamiento de configuraciones'"),
	...
	FillMetadataObjectForms(Metadata.Catalogs, "Catalog", NStr("ru = 'Справочник'; en = 'Catalog'; pl = 'Katalog';de = 'Katalog';ro = 'Catalog';tr = 'Katalog'; es_ES = 'Catálogo'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm", "ChoiceForm");
	FillMetadataObjectForms(Metadata.Documents, "Document", NStr("ru = 'Документ'; en = 'Document'; pl = 'Dokument';de = 'Dokument';ro = 'Document';tr = 'Belge'; es_ES = 'Documento'"),
		StandardFormNames, PictureLib.Document, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("Form");
	FillMetadataObjectForms(Metadata.DocumentJournals, "DocumentJournal", NStr("ru = 'Журнал документов'; en = 'Document journal'; pl = 'Dziennik dokumentów';de = 'Dokument Journal';ro = 'Document jurnal';tr = 'Belge günlüğü'; es_ES = 'Diario de documentos'"),
		StandardFormNames, PictureLib.DocumentJournal, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm", "ChoiceForm");
	FillMetadataObjectForms(Metadata.Enums, "Enum", NStr("ru = 'Перечисление'; en = 'Enumeration'; pl = 'Enum';de = 'Aufzählung';ro = 'Secvența';tr = 'Sıralama'; es_ES = 'Enumeración'"),
	...
	FillMetadataObjectForms(Metadata.Reports, "Report", NStr("ru = 'Отчет'; en = 'Report'; pl = 'Deklaracja';de = 'Bericht';ro = 'Raport';tr = 'Rapor'; es_ES = 'Informe'"),
		StandardFormNames, PictureLib.Report, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("Form");
	FillMetadataObjectForms(Metadata.DataProcessors, "DataProcessor", NStr("ru = 'Обработка'; en = 'Data processor'; pl = 'Opracowanie';de = 'Daten Prozessor';ro = 'Procesare de date';tr = 'Veri işlemcisi'; es_ES = 'Procesador de datos'"),
	...
	StandardFormNames.Add("ChoiceForm", "ChoiceForm");
	StandardFormNames.Add("FolderChoiceForm", "FolderChoiceForm");
	FillMetadataObjectForms(Metadata.ChartsOfCharacteristicTypes, "ChartOfCharacteristicTypes", NStr("ru = 'План видов характеристик'; en = 'Chart of characteristic types'; pl = 'Plan rodzajów charakterystyk';de = 'Diagramm von charakteristischen Typen';ro = 'Diagrama tipurilor caracteristice';tr = 'Özellik türleri çizelgesi'; es_ES = 'Diagrama de los tipos de características'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm", "ChoiceForm");
	FillMetadataObjectForms(Metadata.ChartsOfAccounts, "ChartOfAccounts", NStr("ru = 'План счетов'; en = 'Chart of accounts'; pl = 'Podstawowy plan kont';de = 'Kontenplan';ro = 'Plan de conturi';tr = 'Hesap çizelgesi'; es_ES = 'Diagrama primario de las cuentas'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm", "ChoiceForm");
	FillMetadataObjectForms(Metadata.ChartsOfCalculationTypes, "ChartOfCalculationTypes", NStr("ru = 'План видов расчета'; en = 'Chart of calculation types'; pl = 'Plan typów obliczeń';de = 'Diagramm der Berechnungstypen';ro = 'Graficul tipurilor de calcul';tr = 'Hesaplama türleri çizelgesi'; es_ES = 'Diagrama de los tipos de cálculos'"),
		StandardFormNames, PictureLib.ChartOfCalculationTypes, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("RecordForm");
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.InformationRegisters, "InformationRegister", NStr("ru = 'Регистр сведений'; en = 'Information register'; pl = 'Rejestru informacji';de = 'Informationsregister';ro = 'Registrul de informații';tr = 'Bilgi kaydı'; es_ES = 'Registro de información'"),
		StandardFormNames, PictureLib.InformationRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.AccumulationRegisters, "AccumulationRegister", NStr("ru = 'Регистр накопления'; en = 'Accumulation register'; pl = 'Rejestru akumulacji';de = 'Akkumulationsregister';ro = 'Registrul de acumulare';tr = 'Birikeç '; es_ES = 'Registro de acumulación'"),
		StandardFormNames, PictureLib.AccumulationRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.AccountingRegisters, "AccountingRegister", NStr("ru = 'Регистр бухгалтерии'; en = 'Accounting register'; pl = 'Rejestru księgowego';de = 'Buchhaltungsregister';ro = 'Registrul contabil';tr = 'Muhasebe kaydı'; es_ES = 'Registro de contabilidad'"),
		StandardFormNames, PictureLib.AccountingRegister, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.CalculationRegisters, "CalculationRegister", NStr("ru = 'Регистр расчета'; en = 'Calculation register'; pl = 'Rejestr kalkulacji';de = 'Berechnungsregister';ro = 'Registrul de calcul';tr = 'Hesaplama kaydı'; es_ES = 'Registro de cálculos'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm", "ChoiceForm");
	FillMetadataObjectForms(Metadata.BusinessProcesses, "BusinessProcess", NStr("ru = 'Бизнес-процесс'; en = 'Business process'; pl = 'Proces biznesowy';de = 'Geschäftsprozess';ro = 'Procesul de afaceri';tr = 'İş süreci'; es_ES = 'Proceso de negocio'"),
	...
	StandardFormNames.Add("ListForm");
	StandardFormNames.Add("ChoiceForm", "ChoiceForm");
	FillMetadataObjectForms(Metadata.Tasks, "Task", NStr("ru = 'Задача'; en = 'Task'; pl = 'Zadanie';de = 'Aufgabe';ro = 'Sarcină';tr = 'Görev'; es_ES = 'Tarea'"),
		StandardFormNames, PictureLib.Task, FormsList);
	
	StandardFormNames = New ValueList;
	StandardFormNames.Add("RecordForm");
	StandardFormNames.Add("ListForm");
	FillMetadataObjectForms(Metadata.ExternalDataSources, "ExternalDataSource", NStr("ru = 'Внешние источники данных'; en = 'External data sources'; pl = 'Zewnętrzne źródła danych';de = 'Externe Datenquellen';ro = 'Surse de date externe';tr = 'Dış veri kaynakları'; es_ES = 'Fuentes de datos externos'"),
...
Procedure FillMetadataObjectForms(MetadataObjectList, MetadataObjectType,
	...
	For Each Object In MetadataObjectList Do
		...
		For Each Form In Object.Forms Do
			...
			Checkmark = FormPresentationAndMark.CanOpenForm;
			FormsList.Add(NamePrefix + ".Form." + Form.Name, PresentationPrefix + FormPresentation, Checkmark, Picture);
		EndDo;
		...
		For Each StandardFormName In StandardFormNames Do
			...
			If Form = Undefined Then
				...
				FormPresentation = FormPresentationAndMark.FormName;
				Checkmark = FormPresentationAndMark.CanOpenForm;
				FormsList.Add(NamePrefix + "." + FormName, PresentationPrefix + FormPresentation, Checkmark, Picture);
			EndIf;
...
//   Sources - Array, where an array element is Catalog.UserRef. An array of users whose settings 
//             have to be cleared.
//
...
Procedure CopyReportOptions(ReportOptionArray, UserReportOptionTable,
		...
		If FoundReportOption[0].StandardProcessing Then
			...
			Except
				Continue;
			EndTry;
			SettingDetails = ReportsVariantsStorage.GetDescription(ReportKey, OptionKey, InfobaseUser);
			
			For Each SettingsRecipient In RecipientUsers Do
				SettingsRecipient = IBUserName(SettingsRecipient);
				ReportsVariantsStorage.Save(ReportKey, OptionKey, Value, SettingDetails, SettingsRecipient);
			EndDo;
...
Procedure AddFormTypeToPresentation(Object, Form, FormName)
	...
	If Form = Object.DefaultListForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 (список)'; en = '%1 (list)'; pl = '%1 (lista)';de = '%1 (Liste)';ro = '%1 (lista)';tr = '%1 (liste)'; es_ES = '%1 (lista)'"), FormName);
	ElsIf Form = Object.DefaultChoiceForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 (выбор)'; en = '%1 (choice)'; pl = '%1 (wybór)';de = '%1 (Auswahl)';ro = '%1 (selecţie)';tr = '%1 (seçim)'; es_ES = '%1 (selección)'"), FormName);
	ElsIf Form = Object.DefaultFolderForm Then
		FormName = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = '%1 (группа)'; en = '%1 (group)'; pl = '%1 (grupa)';de = '%1 (Gruppe)';ro = '%1 (grup)';tr = '%1 (grup)'; es_ES = '%1 (grupo)'"), FormName);
	EndIf;
...
Function CreateReportOnCopyingSettings(NotCopiedReportSettings,
	...
	If UserReportOptionTable <> Undefined
		...
		AreaHeader.Parameters.Details = 
			...
			|ro = 'Nu puteți copia variantele personale ale rapoartelor.
			|Pentru ca varianta personală a raportului să devină accesibilă pentru alți utilizatori
			|trebuie s-o salvați din nou cu marcajul scos ""Numai pentru autor"".
			|Lista variantelor omise ale rapoartelor:';
			|tr = '
	...
	If NotCopiedReportSettings.Count() <> 0 Then
		AreaHeader = TabTemplate.GetArea("Title");
		AreaHeader.Parameters.Details = 
			NStr("ru = 'У следующих пользователей недостаточно прав на отчеты:'; en = 'The following users have insufficient access rights for reports:'; pl = 'Następujący użytkownicy nie mają wystarczających uprawnień do raportów:';de = 'Folgende Benutzer haben keine ausreichenden Rechte für die Berichte:';ro = 'Următorii utilizatori au drepturi insuficiente pentru rapoarte:';tr = 'Aşağıdaki kullanıcılar raporlar için yetersiz haklara sahiptir:'; es_ES = 'Los siguientes usuarios tienen insuficientes derechos para los informes:'");
		SpreadsheetDoc.Put(AreaHeader);
...
Procedure FillInterfaceSettingsList(Parameters)
	...
	For Each FormSettingsItem In FormSettings Do
		...
		ElsIf MetadataObjectPresentation[0] = NStr("ru = 'Стандартные'; en = 'Standard'; pl = 'Standardowe';de = 'Standard';ro = 'Standard';tr = 'Standart'; es_ES = 'Estándares'") Then
	...
	Setting = NStr("ru = 'Командный интерфейс и начальная страница'; en = 'Command interface and home page'; pl = 'Interfejs poleceń i strona początkowa';de = 'Befehlsoberfläche und Startseite';ro = 'Interfața de comandă și pagina inițială';tr = 'Komut arayüzü ve ana sayfa'; es_ES = 'Interfaz de comando y página principal'");
...
Procedure FillOtherSettingsList(Parameters)
	...
	If Keys.Count() > 0 Then
		...
		If Not IsBlankString(Parameters.Search) Then
			If StrFind(Upper(NStr("ru = 'Персональные настройки'; en = 'Personal settings'; pl = 'Osobiste ustawienia';de = 'Persönliche Einstellungen';ro = 'Setări personale';tr = 'Kişisel ayarlar'; es_ES = 'Configuraciones personales'")), Upper(Parameters.Search)) = 0 Then
				OutputSettingsItem = False;
			EndIf;
		EndIf;
		
		If OutputSettingsItem Then
			Setting = NStr("ru = 'Персональные настройки'; en = 'Personal settings'; pl = 'Osobiste ustawienia';de = 'Persönliche Einstellungen';ro = 'Setări personale';tr = 'Kişisel ayarlar'; es_ES = 'Configuraciones personales'");
	...
	If Not IsBlankString(Parameters.Search) Then
		...
		If StrFind(Upper(NStr("ru = 'Настройки печати табличных документов'; en = 'Spreadsheet document print settings'; pl = 'Ustawienia drukowania dokumentu arkuszy kalkulacyjnych';de = 'Druckeinstellungen für das Tabellenblatt';ro = 'Setările pentru imprimarea foilor de calcul tabelar';tr = 'Elektronik sayfa belge yazdırma ayarları'; es_ES = 'Configuraciones de la impresión de los documentos de la hoja de cálculo'")), Upper(Parameters.Search)) = 0 Then
			OutputSettingsItem = False;
		EndIf;
	...
	If Not IsBlankString(Parameters.Search) Then
		...
		If StrFind(Upper(NStr("ru = 'Избранное'; en = 'Favorites'; pl = 'Ulubione';de = 'Favoriten';ro = 'Favorite';tr = 'Sık kullanılanlar'; es_ES = 'Favoritos'")), Upper(Parameters.Search)) = 0 Then
			OutputSettingsItem = False;
		EndIf;
	...
	If HasFavorites
		...
		Setting = NStr("ru = 'Избранное'; en = 'Favorites'; pl = 'Ulubione';de = 'Favoriten';ro = 'Favorite';tr = 'Sık kullanılanlar'; es_ES = 'Favoritos'");
	...
	If Not IsBlankString(Parameters.Search) Then
		...
		If StrFind(Upper(NStr("ru = 'Прочие настройки'; en = 'Other settings'; pl = 'Inne ustawienia';de = 'Andere Einstellungen';ro = 'Alte setări';tr = 'Diğer ayarlar'; es_ES = 'Otras configuraciones'")), Upper(Parameters.Search)) = 0 Then
			OutputSettingsItem = False;
		EndIf;
	...
	If OtherKeys.Count() <> 0
		AND OutputSettingsItem Then
		Setting = NStr("ru = 'Прочие настройки'; en = 'Other settings'; pl = 'Inne ustawienia';de = 'Andere Einstellungen';ro = 'Alte setări';tr = 'Diğer ayarlar'; es_ES = 'Otras configuraciones'");
		Picture = PictureLib.OtherUserSettings;
...
Procedure AddDesktopAndCommandInterfaceSettings(Parameters, SettingsTree)
	...
	If Not IsBlankString(Parameters.Search) Then
		If StrFind(Upper(NStr("ru = 'Командный интерфейс и начальная страница'; en = 'Command interface and home page'; pl = 'Interfejs poleceń i strona początkowa';de = 'Befehlsoberfläche und Startseite';ro = 'Interfața de comandă și pagina inițială';tr = 'Komut arayüzü ve ana sayfa'; es_ES = 'Interfaz de comando y página principal'")), Upper(Parameters.Search)) = 0 Then
			Return;
		EndIf;
	EndIf;
	...
	If DesktopSettingsKeys.Count() > 0 Then
		...
		NewSubordinateInterfaceRow.Settings = NStr("ru = 'Начальная страница'; en = 'Home page'; pl = 'Strona podstawowa';de = 'Startseite';ro = 'Pagina principală';tr = 'Ana sayfa'; es_ES = 'Página principal'");
	...
	If InterfaceSettingsKeys.Count() > 0 Then
		...
		NewSubordinateInterfaceRow = NewInterfaceRow.Rows.Add();
		NewSubordinateInterfaceRow.Settings = NStr("ru = 'Командный интерфейс'; en = 'Command interface'; pl = 'Interfejs poleceń';de = 'Befehlsschnittstelle';ro = 'Comanda interfață';tr = 'Komut arayüzü'; es_ES = 'Interfaz de comandos'");
		NewSubordinateInterfaceRow.Picture = PictureLib.Picture;
