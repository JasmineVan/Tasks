...
Procedure OnClose(Exit)
	...
	If DataSavedToSettingsStorage
	   AND TypeOf(FormOwner) = Type("ManagedForm") Then
...
Procedure RefreshPageTitle(SettingsCount)
	...
	If SelectedSettingsPage = "ReportSettingsPage" Then
		...
		If ReportSettingsCount = 0 Then
			TitleText = NStr("ru='Настройки отчетов'; en = 'Report settings'; pl = 'Ustawienia sprawozdań';de = 'Berichtseinstellungen';ro = 'Setările rapoartelor';tr = 'Rapor ayarları'; es_ES = 'Ajustes de informes'");
		Else
			TitleText = NStr("ru='Настройки отчетов (%1)'; en = 'Report settings (%1)'; pl = 'Ustawienia sprawozdania (%1)';de = 'Berichteinstellungen (%1)';ro = 'Setările raportului (%1)';tr = 'Rapor ayarları (%1)'; es_ES = 'Configuraciones del informe (%1)'");
	...
	ElsIf SelectedSettingsPage = "InterfacePage" Then
		...
		If InterfaceSettingsCount = 0 Then
			TitleText = NStr("ru='Внешний вид'; en = 'Interface settings'; pl = 'Ustawienia wyglądu';de = 'Aussehen Einstellungen';ro = 'Setările aspectului extern';tr = 'Görünüm ayarları'; es_ES = 'Configuraciones del aspecto'");
		Else
			TitleText = NStr("ru='Внешний вид (%1)'; en = 'Interface settings (%1)'; pl = 'Formatowanie (%1)';de = 'Erscheinen (%1)';ro = 'Aspectul (%1)';tr = 'Düzenleme (%1)'; es_ES = 'Aspecto (%1)'");
	...
	ElsIf SelectedSettingsPage = "OtherSettingsPage" Then
		...
		If OtherSettingsCount = 0 Then
			TitleText = NStr("ru='Прочие настройки'; en = 'Other settings'; pl = 'Inne ustawienia';de = 'Andere Einstellungen';ro = 'Alte setări';tr = 'Diğer ayarlar'; es_ES = 'Otras configuraciones'");
		Else
			TitleText = NStr("ru='Прочие настройки (%1)'; en = 'Other settings (%1)'; pl = 'Inne ustawienia (%1)';de = 'Andere Einstellungen (%1)';ro = 'Alte setări (%1)';tr = 'Diğer ayarlar (%1)'; es_ES = 'Otras configuraciones (%1)'");
...
Procedure ImportMarkValues(ValuesTree, MarkedSettings, SettingsType)
	...
	If MarkedItemCount > 0 Then
		...
		If SettingsType = "ReportSettings" Then
			...
			Items.ReportSettingsPage.Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru='Настройки отчетов (%1)'; en = 'Report settings (%1)'; pl = 'Ustawienia sprawozdania (%1)';de = 'Berichteinstellungen (%1)';ro = 'Setările raportului (%1)';tr = 'Rapor ayarları (%1)'; es_ES = 'Configuraciones del informe (%1)'"), MarkedItemCount);
		ElsIf SettingsType = "Interface" Then
			InterfaceSettingsCount = MarkedItemCount;
			Items.InterfacePage.Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru='Внешний вид (%1)'; en = 'Interface settings (%1)'; pl = 'Formatowanie (%1)';de = 'Erscheinen (%1)';ro = 'Aspectul (%1)';tr = 'Düzenleme (%1)'; es_ES = 'Aspecto (%1)'"), MarkedItemCount);
		ElsIf SettingsType = "OtherSettings" Then
			OtherSettingsCount = MarkedItemCount;
			Items.OtherSettingsPage.Title = StringFunctionsClientServer.SubstituteParametersToString(NStr("ru='Прочие настройки (%1)'; en = 'Other settings (%1)'; pl = 'Inne ustawienia (%1)';de = 'Andere Einstellungen (%1)';ro = 'Alte setări (%1)';tr = 'Diğer ayarlar (%1)'; es_ES = 'Otras configuraciones (%1)'"), MarkedItemCount);
		EndIf;
