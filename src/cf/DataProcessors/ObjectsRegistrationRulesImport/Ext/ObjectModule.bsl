...
Function RulesInformation() Export
	...
	InfoString = NStr("ru = 'Правила регистрации объектов этой информационной базы (%1) от %2'; en = 'Object registration rules in this infobase (%1) created on %2'; pl = 'Reguły rejestracji obiektu dla tej bazy informacyjnej (%1) z %2';de = 'Objekt-Registrierungsregeln dieser Infobase (%1) aus %2';ro = 'Regulile de înregistrare a obiectelor acestei baze de informații (%1) din %2';tr = '%1''dan veritabanın (%2) nesne kayıt  kuralları'; es_ES = 'Reglas del registro de objetos de esta infobase (%1) de %2'");
...
Procedure CheckExchangePlanExists()
	...
	If Registration.ExchangePlanName <> ExchangePlanNameForImport Then
		...
		ErrorDescription = NStr("ru = 'В правилах регистрации указан план обмена %1, а загрузка выполняется для плана обмена %2'; en = 'The exchange plan name specified in the registration rules (%1) does not match the exchange plan name whose data is imported (%2)'; pl = 'W zasadach rejestracji jest określony plan wymiany %1, a pobieranie jest wykonywane dla planu wymiany %2';de = 'Der Austauschplan %1 ist in den Registrierungsregeln angegeben und der Importvorgang ist für den Austauschplan gültig %2';ro = 'În regulile de înregistrare este indicat planul de schimb %1, iar încărcarea se face pentru planul de schimb %2';tr = 'Alışveriş planı %1 kayıt kurallarında belirtilmiştir ve devam eden içe aktarma %2 alışveriş planı içindir'; es_ES = 'Plan de intercambio %1 está especificado en las reglas del registro, y la importación está en progreso para el plan de intercambio %2'");
...
Function InitMessages()
	...
	Messages.Insert(0, NStr("ru = 'Внутренняя ошибка'; en = 'Internal error'; pl = 'Błąd zewnętrzny';de = 'Interner Fehler';ro = 'Eroare internă';tr = 'Dahili hata'; es_ES = 'Error interno'", DefaultLanguageCode));
	Messages.Insert(1, NStr("ru = 'Ошибка открытия файла правил'; en = 'Cannot open the exchange rules file.'; pl = 'Błąd otwarcia pliku reguł';de = 'Beim Öffnen der Regeldatei ist ein Fehler aufgetreten';ro = 'Eroare la deschiderea fișierului de reguli';tr = 'Kural dosyası açılırken bir hata oluştu'; es_ES = 'Ha ocurrido un error al abrir el archivo de reglas'", DefaultLanguageCode));
	Messages.Insert(2, NStr("ru = 'Ошибка при загрузке правил'; en = 'Cannot load the exchange rules.'; pl = 'Błąd podczas importu reguł';de = 'Beim Importieren von Regeln ist ein Fehler aufgetreten';ro = 'Eroare la încărcarea regulilor';tr = 'Kurallar içe aktarılırken bir hata oluştu'; es_ES = 'Ha ocurrido un error al importar las reglas'", DefaultLanguageCode));
	Messages.Insert(3, NStr("ru = 'Ошибка формата правил'; en = 'Exchange rule format error.'; pl = 'Błąd formatu reguł';de = 'Regelformatfehler';ro = 'Eroare formatare a regulii';tr = 'Kural biçimi hatası'; es_ES = 'Error de formato de la regla'", DefaultLanguageCode));
	Messages.Insert(4, NStr("ru = 'Ошибка при получении файла правил для чтения'; en = 'Cannot get the exchange rules file for reading.'; pl = 'Wystąpił błąd podczas odbierania pliku reguły odczytu';de = 'Beim Empfang einer Leseregeldatei ist ein Fehler aufgetreten';ro = 'Eroare la primirea fișierului regulilor pentru citire';tr = 'Bir okuma kuralı dosyası alınırken hata oluştu'; es_ES = 'Ha ocurrido un error al recibir un archivo de reglas de lectura'", DefaultLanguageCode));
	Messages.Insert(5, NStr("ru = 'Загружаемые правила регистрации не предназначены для текущего плана обмена.'; en = 'The registration rules are not intended for the current exchange plan.'; pl = 'Zaimportowane reguły rejestracji nie dotyczą bieżącego planu wymiany.';de = 'Importierte Registrierungsregeln sind nicht für den aktuellen Austauschplan.';ro = 'Regulile de înregistrare încărcate nu sunt destinate pentru planul de schimb curent.';tr = 'İçe aktarılan kayıt kuralları mevcut alışveriş planı için geçerli değildir.'; es_ES = 'Reglas del registro de la importación no son para el plan de intercambio actual.'", DefaultLanguageCode));
