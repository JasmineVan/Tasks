...
Function AllDocumentsFilterGroupTitle() Export
	Return NStr("ru='Все документы'; en = 'All documents'; pl = 'Wszystkie dokumenty';de = 'Alle Dokumente';ro = 'Toate documentele';tr = 'Tüm belgeler'; es_ES = 'Todos documentos'");
EndFunction
...
Function AllCatalogsFilterGroupTitle() Export
	Return NStr("ru='Все справочники'; en = 'All catalogs'; pl = 'Wszystkie katalogi';de = 'Alle Kataloge';ro = 'Toate cataloagele';tr = 'Tüm kataloglar'; es_ES = 'Todos catálogos'");
EndFunction
...
Function InitializeComposer(MetadataNameList = Undefined, LimitUsageWithFilter = False, SchemaSavingAddress = Undefined)
	...
	AutomaticallyParameter.Value = NStr("ru = 'По общим правилам'; en = 'By common rules'; pl = 'Według wspólnych zasad';de = 'Nach allgemeinen Regeln';ro = 'Prin reguli comune';tr = 'Genel kurallara göre'; es_ES = 'Por reglas comunes'");
	
	AdditionallyParameter = Parameters.Find("RegistrationReasonAdvanced");
	AdditionallyParameter.Value = NStr("ru = 'Дополнительно'; en = 'Additional registration'; pl = 'Więcej';de = 'Mehr';ro = 'Mai mult';tr = 'Daha fazla'; es_ES = 'Más'");
	
	ParameterByRef = Parameters.Find("RegistrationReasonByRef");
	ParameterByRef.Value = NStr("ru = 'По ссылке'; en = 'By reference'; pl = 'Przez odniesienie\link';de = 'Mit Bezugnahme';ro = 'De referință';tr = 'Referans olarak'; es_ES = 'Por referencia'");
...
Procedure AddTabularSectionCompositionAdditionalSets(SourceItems, AddingOptions)
	...
	If ObjectMetadata = Undefined Then
		Raise StringFunctionsClientServer.SubstituteParametersToString(NStr("ru='Некорректное имя метаданных ""%1"" для регистрации на узле ""%2""'; en = 'Invaild metadata name ""%1"" for registration at node ""%2"".'; pl = 'Nieprawidłowa nazwa metadanych ""%1"" do rejestracji w węźle ""%2""';de = 'Falscher Metadatenname ""%1"" für die Registrierung auf dem Knoten ""%2""';ro = 'Nume de metadate incorect ""%1"" pentru înregistrare pe nodul ""%2""';tr = '%1 ünitesinde kayıt için meta verilerin %2  yanlış adı'; es_ES = 'Nombre incorrecto de metadatos ""%1"" para registrar en el nodo ""%2""'"),
...
Function AdditionalParameterText()
	...
	If ExportOption = 0 Then
		// All automatic data
		Return NStr("ru='Без дополнительных данных.'; en = 'No additional data.'; pl = 'Bez dodatkowych danych.';de = 'Ohne zusätzliche Daten.';ro = 'Fără date suplimentare.';tr = 'Ek veri yok.'; es_ES = 'Sin datos adicionales.'");
