...
Procedure Save(Command)
	...
	Result.ErrorText = NStr("ru='Не удалось сохранить отсканированный файл.'; en = 'Cannot save the scanned file.'; pl = 'Nie udało się zapisać zeskanowany plik.';de = 'Die gescannte Datei konnte nicht gespeichert werden.';ro = 'Eșec la salvarea fișierului scanat.';tr = 'Taranmış dosya kaydedilemedi.'; es_ES = 'No se ha podido guardar el archivo escaneado.'");
	AcceptCompletion(Result, ExecutionParameters);
EndProcedure
		...
		If ErrorsCount = 1 Then
			WarningText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Не удалось сохранить файл по причине:
					...
					|%1';
					|ro = 'Eșec la salvarea comenzii din motivul:
					|%1';
					|tr = 'Dosya 
		...
		Else
			WarningText = StringFunctionsClientServer.SubstituteParametersToString(
				NStr("ru = 'Не удалось сохранить некоторые файлы (%1):
					...
					|%2';
					|ro = 'Eșec la salvarea unor fișiere (%1):
					|%2';
...
Procedure TransformCalculationsToParametersAndGetPresentation()
	...
	If UseImageMagickToConvertToPDF Then
		If SinglePageStorageFormat = Enums.SinglePageFileStorageFormats.PDF Then
			...
			Presentation = Presentation + NStr("ru = 'Формат хранения:'; en = 'Storage format:'; pl = 'Format przechowywania:';de = 'Speicherformat:';ro = 'Formatul de stocare:';tr = 'Depolama biçimi:'; es_ES = 'Formato de almacenamiento:'") + " ";
			Presentation = Presentation + "PDF";
			Presentation = Presentation + ". ";
			Presentation = Presentation + NStr("ru = 'Формат сканирования:'; en = 'Scanning format:'; pl = 'Format skanowania:';de = 'Scan-Format:';ro = 'Formatul de scanare:';tr = 'Tarama biçimi:'; es_ES = 'Formato de escaneo:'") + " ";
	...
	If Upper(PictureFormat) = "JPG" Then
		Presentation = Presentation +  NStr("ru = 'Качество:'; en = 'Quality:'; pl = 'Jakość:';de = 'Qualität:';ro = 'Calitatea:';tr = 'Kalite:'; es_ES = 'Calidad:'") + " " + String(JPGQuality) + ". ";
	EndIf;	
	
	If Upper(PictureFormat) = "TIF" Then
		Presentation = Presentation +  NStr("ru = 'Сжатие:'; en = 'Compression:'; pl = 'Kompresja:';de = 'Komprimierung:';ro = 'Comprimare:';tr = 'Sıkıştırma:'; es_ES = 'Compresión:'") + " " + String(TIFFDeflation) + ". ";
	EndIf;
	
	Presentation = Presentation + NStr("ru = 'Формат хранения многостраничный:'; en = 'Multipage storage format:'; pl = 'Wielostronicowy format przechowywania:';de = 'Mehrseitiges Speicherformat:';ro = 'Formatul de stocare pe mai multe pagini:';tr = 'Çok sayfalı depolama biçimi:'; es_ES = 'Formato de almacenamiento de páginas múltiples:'") + " ";
	...
	Presentation = Presentation + StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Разрешение: %1 dpi. %2.'; en = 'Resolution: %1 dpi. %2.'; pl = 'Rozdzielczość: %1 dpi. %2.';de = 'Auflösung: %1 dpi. %2.';ro = 'Rezoluția: %1 dpi. %2.';tr = 'Çözünürlük: %1 dpi. %2.'; es_ES = 'Resolución: %1 dpi. %2.'") + " ",
		String(Permission), String(ColorDepthEnum));
	
	If NOT RotationEnum.IsEmpty() Then
		Presentation = Presentation +  NStr("ru = 'Поворот:'; en = 'Rotation:'; pl = 'Obrót:';de = 'Rotation:';ro = 'Rotația:';tr = 'Dönme'; es_ES = 'Rotación:'")+ " " + String(RotationEnum) + ". ";
	EndIf;	
	
	If NOT PaperSizeEnum.IsEmpty() Then
		Presentation = Presentation +  NStr("ru = 'Размер бумаги:'; en = 'Paper size:'; pl = 'Rozmiar papieru:';de = 'Papiergröße:';ro = 'Dimensiunea hârtiei:';tr = 'Kağıt boyutu:'; es_ES = 'Tamaño de papel:'") + " " + String(PaperSizeEnum) + ". ";
	EndIf;	
	
	If DuplexScanning = True Then
		Presentation = Presentation +  NStr("ru = 'Двустороннее сканирование'; en = 'Scan both sides'; pl = 'Skanowanie dwustronne';de = 'Beide Seiten scannen';ro = 'Scanați ambele părți';tr = 'Çift taraflı tarama'; es_ES = 'Escanear a doble cara'") + ". ";
	EndIf;	
...
Function MessageTextOfTransformToPDFError(ResultFile)
	...
	MessageText = StringFunctionsClientServer.SubstituteParametersToString(
		NStr("ru = 'Не найден файл ""%1"".
		           ...
		           |ro = 'Fișierul ""%1"" nu este găsit.
		           |Verificați dacă este instalată aplicația ImageMagick și
		           |este specificată calea corectă spre programul de conversie în
		           |PDF în forma setărilor de scanare.';
		           |tr = '""%1"" Dosyası bulunamadı. ImageMagickis  uygulamasının yüklü olup olmadığını ve 
