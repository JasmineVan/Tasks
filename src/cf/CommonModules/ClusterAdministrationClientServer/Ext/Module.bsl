...
// Obsolete. Please use ClusterAdministration.ClusterAdministrationParameters.
...
// Obsolete. Please use ClusterAdministration.ClusterInfobaseAdministrationParameters.
...
// Obsolete. Please use ClusterAdministration.CheckAdministrationParameters.
...
// Obsolete. Please use ClusterAdministration.SessionAndScheduleJobLockProperties.
...
// Obsolete. Please use ClusterAdministration.InfobaseSessionAndJobLock.
...
// Obsolete. Please use ClusterAdministration.SetInfobaseSessionAndJobLock.
...
// Obsolete. Please use ClusterAdministration.RemoveInfobaseSessionAndJobLock.
...
// Obsolete. Please use ClusterAdministration.InfobaseScheduledJobLock.
...
// Obsolete. Please use ClusterAdministration.SetInfobaseScheduledJobLock.
...
// Obsolete. Please use ClusterAdministration.SessionProperties.
...
// Obsolete. Please use ClusterAdministration.InfobaseSessions.
...
// Obsolete. Please use ClusterAdministration.DeleteInfobaseSessions.
...
// Obsolete. Please use ClusterAdministration.ConnectionProperties.
...
// Obsolete. Please use ClusterAdministration.InfobaseConnections.
...
// Obsolete. Please use ClusterAdministration.TerminateInfobaseConnections.
...
// Obsolete. Please use ClusterAdministration.InfobaseSecurityProfile.
...
// Obsolete. Please use ClusterAdministration.InfobaseSafeModeSecurityProfile.
...
// Obsolete. Please use ClusterAdministration.SetInfobaseSecurityProfile.
...
// Obsolete. Please use ClusterAdministration.SetInfobaseSafeModeSecurityProfile.
...
// Obsolete. Please use ClusterAdministration.SecurityProfileExists.
...
// Obsolete. Please use ClusterAdministration.SecurityProfileProperties.
...
// Obsolete. Please use ClusterAdministration.VirtualDirectoryProperties.
...
// Obsolete. Please use ClusterAdministration.COMClassProperties.
...
// Obsolete. Please use ClusterAdministration.AddInProperties.
...
// Obsolete. Please use ClusterAdministration.ExternalModuleProperties.
...
// Obsolete. Please use ClusterAdministration.OSApplicationProperties.
...
// Obsolete. Please use ClusterAdministration.InternetResourceProperties.
...
// Obsolete. Please use ClusterAdministration.SecurityProfile.
...
// Obsolete. Please use ClusterAdministration.CreateSecurityProfile.
...
// Obsolete. Please use ClusterAdministration.SetSecurityProfileProperties.
...
// Obsolete. Please use ClusterAdministration.DeleteSecurityProfile.
...
// Obsolete. Please use ClusterAdministration.InfobaseID.
...
// Obsolete. Please use ClusterAdministration.InfobasesProperties.
...
// Obsolete. Please use ClusterAdministration.ClusterID.
...
// Obsolete. Please use ClusterAdministration.ClusterProperties.
...
// Obsolete. Please use ClusterAdministration.WorkingProcessesProperties.
...
// Obsolete. Please use ClusterAdministration.WorkingServerProperties.
...
// Obsolete. Please use ClusterAdministration.SessionsProperties.
// Returns descriptions of infobase sessions.
//
// Parameters:
//  ClusterID - String - the internal ID of a server cluster.
...
// Obsolete. Please use ClusterAdministration.ConnectionsProperties.
// Returns descriptions of infobase connections.
//
// Parameters:
//  ClusterID - String - the internal ID of a server cluster.
...
// Obsolete. Please use ClusterAdministration.PathToAdministrationServerClient.
...
Procedure AddFilterCondition(Filter, Val Property, Val ValueComparisonType, Val Value) Export
	...
	Else
		...
		Raise NStr("ru = 'Некорректно задано описание фильтра.'; en = 'Invalid filter description.'; pl = 'Niepoprawnie podano opis filtru.';de = 'Die Filterbeschreibung ist falsch.';ro = 'Descrierea filtrului este specificată incorect.';tr = 'Filtre yanlış tanımlanmıştır.'; es_ES = 'La descripción del filtro se ha especificado incorrectamente.'");
...
Function CheckFilterConditions(Val ObjectToCheck, Val Filter = Undefined) Export
	...
	For Each Condition In Filter Do
		...
		Else
			...
			Raise NStr("ru = 'Некорректно задан фильтр.'; en = 'Invalid filter.'; pl = 'Niepoprawnie podano filtr.';de = 'Der Filter ist falsch eingestellt.';ro = 'Filtrul este setat incorect.';tr = 'Filtre yanlış ayarlanmıştır.'; es_ES = 'El filtro se ha especificado incorrectamente.'");
...
Function AdministrationManager(Val AdministrationParameters)
	...
	Else
		...
		Raise StringFunctionsClientServer.SubstituteParametersToString(NStr("ru = 'Неизвестный тип подключения: %1.'; en = 'Unknown connection type: %1.'; pl = 'Nieznany typ połączenia: %1.';de = 'Unbekannter Verbindungstyp: %1.';ro = 'Tip de conexiune necunoscut: %1.';tr = 'Bilinmeyen bağlantı türü: %1'; es_ES = 'Tipo de conexión desconocido: %1.'"), AdministrationParameters.ConnectionType);
