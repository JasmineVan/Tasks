...
//
// Parameters:
//  ParametersTable			 - ValueTable - a table with the parameter list.
//  ParameterName				 - String - a name of the parameter to add.
...
Function GenerateSendOptions(Template, Topic, UUID, AdditionalParameters = Undefined)
	
	SendOptions = MessageTemplatesClientServer.SendOptionsConstructor(Template.Ref, Topic, UUID);
	If TypeOf(AdditionalParameters) = Type("Structure") Then
		CommonClientServer.SupplementStructure(SendOptions.AdditionalParameters, AdditionalParameters, True);
	EndIf;
...
// Handler of the ProcessGetForm event subscription for overriding a file form.
//
// Parameters:
...
//  SelectedForm           - String - a name or a metadata object of a form to open.
//  AdditionalInformation - Structure - additional information of the form opening.
//  StandardProcessing     - Boolean - indicates standard (system) event processing execution.
//
Procedure DetermineAttachedFileForm(Source, FormKind, Parameters,
	...
	If Common.SubsystemExists("StandardSubsystems.FilesOperations") Then
		...
		ModuleFilesOperations.DetermineAttachedFileForm(Source, FormKind, Parameters,
