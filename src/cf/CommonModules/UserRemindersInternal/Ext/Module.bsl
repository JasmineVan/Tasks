...
Function StandardNotifyIntervals()
	...
	Result = New Array;
	Result.Add(NStr("ru = '5 минут'; en = '5 minutes'; pl = '5 minut';de = '5 Minuten';ro = '5 minute';tr = '5 dakika'; es_ES = '5 minutos'"));
	Result.Add(NStr("ru = '10 минут'; en = '10 minutes'; pl = '10 minut';de = '10 Minuten';ro = '10 minute';tr = '10 dakika'; es_ES = '10 minutos'"));
	Result.Add(NStr("ru = '15 минут'; en = '15 minutes'; pl = '15 minut';de = '15 Minuten';ro = '15 minute';tr = '15 dakika'; es_ES = '15 minutos'"));
	Result.Add(NStr("ru = '30 минут'; en = '30 minutes'; pl = '30 minut';de = '30 Minuten';ro = '30 minute';tr = '30 dakika'; es_ES = '30 minutos'"));
	Result.Add(NStr("ru = '1 час'; en = '1 hour'; pl = '1 godzina';de = '1 Stunde';ro = '1 oră';tr = '1 saat'; es_ES = '1 hora'"));
	Result.Add(NStr("ru = '2 часа'; en = '2 hours'; pl = '2 godziny';de = '2 Stunden';ro = '2 ore';tr = '2 saat'; es_ES = '2 horas'"));
	Result.Add(NStr("ru = '4 часа'; en = '4 hours'; pl = '4 godziny';de = '4 Stunden';ro = '4 ore';tr = '4 saat'; es_ES = '4 horas'"));
	Result.Add(NStr("ru = '8 часов'; en = '8 hours'; pl = '8 godzin';de = '8 Stunden';ro = '8 ore';tr = '8 saat'; es_ES = '8 horas'"));
	Result.Add(NStr("ru = '1 день'; en = '1 day'; pl = '1 dzień';de = '1 Tag';ro = '1 zi';tr = '1 gün'; es_ES = '1 día'"));
	Result.Add(NStr("ru = '2 дня'; en = '2 days'; pl = '2 dni';de = '2 Tage';ro = '2 zile';tr = '2 gün'; es_ES = '2 días'"));
	Result.Add(NStr("ru = '3 дня'; en = '3 days'; pl = '3 dni';de = '3 Tage';ro = '3 zile';tr = '3 gün'; es_ES = '3 días'"));
	Result.Add(NStr("ru = '1 неделю'; en = '1 week'; pl = '1 tydzień';de = '1 Woche';ro = '1 săptămână';tr = '1 hafta'; es_ES = '1 semana'"));
	Result.Add(NStr("ru = '2 недели'; en = '2 weeks'; pl = '2 tygodnie';de = '2 Wochen';ro = '2 săptămâni';tr = '2 hafta'; es_ES = '2 semanas'"));
...
Function GetStandardSchedulesForReminder()
	...
	Result.Insert(NStr("ru = 'по понедельникам, в 9:00'; en = 'on Mondays at 9.00 AM'; pl = 'w poniedziałki o 9 rano';de = 'montags um 9:00 Uhr';ro = 'Luni la ora 9 a.m.';tr = 'Pazartesi günleri, saat 09:00'; es_ES = 'los lunes a las 09:00'"), Schedule);
	...
	WeekDays.Add(5);
	Schedule.WeekDays = WeekDays;
	Result.Insert(NStr("ru = 'по пятницам, в 15:00'; en = 'on Fridays at 3.00 PM'; pl = 'w piątki o 3 po południu';de = 'freitags um 15:00 Uhr';ro = 'Vineri la ora 3 p.m.';tr = 'Cuma günleri, saat 15:00'; es_ES = 'los viernes a las 15:00'"), Schedule);
	...
	Schedule.WeeksPeriod = 1;
	Schedule.BeginTime = '00010101090000';
	Result.Insert(NStr("ru = 'каждый день, в 9:00'; en = 'every day at 9:00 AM'; pl = 'codziennie o 9:00';de = 'täglich um 9:00 Uhr';ro = 'în fiecare zi la 9:00';tr = 'her gün, saat 9:00'; es_ES = 'cada día a las 09:00'"), Schedule);
...
Procedure CheckForChangesOfDatesInSubject(Topic)
	...
	Query.SetParameter("Source", Topic);
...
Function AttachArbitraryReminder(Text, EventTime, IntervalTillEvent = 0, Topic = Undefined, ID = Undefined) Export
	...
	ReminderParameters.Insert("Source", Topic);
