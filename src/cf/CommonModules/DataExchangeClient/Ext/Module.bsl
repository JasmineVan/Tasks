...
Procedure SetupFormBeforeClose(Cancel, Form, WorkCompletion) Export
	...
	QuestionText = NStr("ru = 'Данные были изменены. Закрыть форму без сохранения изменений?'; en = 'The data was changed. Do you want to close the form without saving the changes?'; pl = 'Dane zostały zmienione. Zamknij formularz bez zapisywania zmian?';de = 'Daten wurden geändert. Schließen Sie das Formular, ohne die Änderungen zu speichern?';ro = 'Datele au fost modificate. Închideți formularul fără a salva modificările?';tr = 'Veriler değiştirildi. Değişiklikleri kaydetmeden formu kapatmak istiyor musunuz?'; es_ES = 'Datos se han cambiado. ¿Cerrar el formulario sin guardar los cambios?'");
...
//	Owner - ManagedForm - a form of selecting correspondent base items.
...
//
// Parameters:
//	Item - ManagedForm, FormTable - an item to process selection.
...
Procedure DeleteSynchronizationSetting(Val InfobaseNode) Export
	...
	If DataExchangeServerCall.IsMasterNode(InfobaseNode) Then
		WarningText = NStr("ru = 'Отключение информационной базы от главного узла можно выполнить
			...
			|en = 'You can detach the infobase from the main node
			|using Designer startup option /ResetMasterNode.'; 
			|pl = 'Odłączenie bazy informacyjnej od głównego węzła można wykonać
			|za pomocą parametrów uruchomienia konfiguratorа /ResetMasterNode.';
			...
			|ro = 'Puteți dezactiva baza de informații de la nodul principal
			|cu ajutorul parametrului de lansare a designerului /ResetMasterNode.';
...
Function DataImportHyperlinksHeaders() Export
	...
	Structure = New Structure;
	Structure.Insert("Undefined",               NStr("ru = 'Получение данных не выполнялось'; en = 'Data was not received.'; pl = 'Odbieranie danych nie zostało wykonane';de = 'Der Datenempfang wurde nicht durchgeführt';ro = 'Obținerea datelor nu s-a executat';tr = 'Veri alma işlemi gerçekleştirilmedi'; es_ES = 'Recibo de los datos no se ha realizado'"));
	Structure.Insert("Error",                     NStr("ru = 'Не удалось получить данные'; en = 'Could not receive data.'; pl = 'Nie można odebrać danych';de = 'Die Daten können nicht empfangen werden';ro = 'Eșec la importul datelor';tr = 'Veri alınamıyor'; es_ES = 'No se puede recibir los datos'"));
	Structure.Insert("CompletedWithWarnings", NStr("ru = 'Данные получены с предупреждениями'; en = 'Data was received with warnings.'; pl = 'Dane zostały odebrane z ostrzeżeniami';de = 'Daten werden mit Warnungen empfangen';ro = 'Datele sunt primite cu avertismente';tr = 'Veriler uyarılarla alındı'; es_ES = 'Datos recibidos con avisos'"));
	Structure.Insert("Success",                      NStr("ru = 'Данные успешно получены'; en = 'Data was received.'; pl = 'Dane zostały pomyślnie odebrane';de = 'Daten werden erfolgreich empfangen';ro = 'Datele au fost importate cu succes';tr = 'Veri başarıyla alındı'; es_ES = 'Datos se han recibido con éxito'"));
	Structure.Insert("Execute",                 NStr("ru = 'Выполняется получение данных...'; en = 'Receiving data...'; pl = 'Odbiór danych...';de = 'Daten empfangen ...';ro = 'Se primesc date...';tr = 'Veri alınıyor ...'; es_ES = 'Recibiendo datos...'"));
	
	Structure.Insert("Warning_ExchangeMessageAlreadyAccepted", NStr("ru = 'Нет новых данных для получения'; en = 'No new data to receive.'; pl = 'Brak nowych danych do odbioru';de = 'Keine neuen Daten erhalten';ro = 'Date noi pentru import lipsesc';tr = 'Alınacak yeni veri yok'; es_ES = 'No hay datos nuevos para recibir'"));
	Structure.Insert("Error_MessageTransport",                      NStr("ru = 'Не удалось получить данные'; en = 'Could not receive data.'; pl = 'Nie można odebrać danych';de = 'Die Daten können nicht empfangen werden';ro = 'Eșec la importul datelor';tr = 'Veri alınamıyor'; es_ES = 'No se puede recibir los datos'"));
...
Function DataExportHyperlinksHeaders() Export
	...
	Structure = New Structure;
	Structure.Insert("Undefined", NStr("ru = 'Отправка данных не выполнялась'; en = 'Data was not sent.'; pl = 'Dane nie zostały wysłane';de = 'Daten wurden nicht gesendet';ro = 'Exportul datelor nu a fost executat';tr = 'Veri gönderilmedi'; es_ES = 'Datos no se han enviado'"));
	Structure.Insert("Error",       NStr("ru = 'Не удалось отправить данные'; en = 'Could not send data.'; pl = 'Nie można wysłać danych';de = 'Die Daten können nicht gesendet werden';ro = 'Eșec la exportul datelor';tr = 'Veri gönderilemiyor'; es_ES = 'No se puede enviar los datos'"));
	Structure.Insert("Success",        NStr("ru = 'Данные успешно отправлены'; en = 'Data was sent.'; pl = 'Dane zostały wysłane pomyślnie';de = 'Daten wurden erfolgreich gesendet';ro = 'Datele au fost exportate cu succes';tr = 'Veri başarıyla gönderildi'; es_ES = 'Datos se han enviado con éxito'"));
	Structure.Insert("Execute",   NStr("ru = 'Выполняется отправка данных...'; en = 'Sending data...'; pl = 'Przesyłanie danych...';de = 'Daten senden...';ro = 'Transmiterea datelor...';tr = 'Veri gönderiliyor...'; es_ES = 'Enviando los datos...'"));
	
	Structure.Insert("Warning_ExchangeMessageAlreadyAccepted", NStr("ru = 'Данные отправлены с предупреждениями'; en = 'Data was sent with warnings.'; pl = 'Dane zostały wysłane z ostrzeżeniami';de = 'Daten werden mit Warnungen gesendet';ro = 'Datele sunt trimise cu avertismente';tr = 'Veriler uyarılarla gönderildi'; es_ES = 'Datos se han enviado con avisos'"));
	Structure.Insert("CompletedWithWarnings",                     NStr("ru = 'Данные отправлены с предупреждениями'; en = 'Data was sent with warnings.'; pl = 'Dane zostały wysłane z ostrzeżeniami';de = 'Daten werden mit Warnungen gesendet';ro = 'Datele sunt trimise cu avertismente';tr = 'Veriler uyarılarla gönderildi'; es_ES = 'Datos se han enviado con avisos'"));
	Structure.Insert("Error_MessageTransport",                      NStr("ru = 'Не удалось отправить данные'; en = 'Could not send data.'; pl = 'Nie można wysłać danych';de = 'Die Daten können nicht gesendet werden';ro = 'Eșec la exportul datelor';tr = 'Veri gönderilemiyor'; es_ES = 'No se puede enviar los datos'"));
...
Procedure OpenSynchronizationDetails(ReferenceToDetails) Export
	...
	If Upper(Left(ReferenceToDetails, 4)) = "HTTP" Then
		...
		FileSystemClient.OpenURL(ReferenceToDetails);
...
Procedure FileDirectoryChoiceHandler(Object, Val PropertyName, StandardProcessing = False, Val DialogParameters = Undefined, CompletionNotification = Undefined) Export
	...
	DialogDefaultOptions.Insert("Title", NStr("ru = 'Укажите каталог'; en = 'Select directory'; pl = 'Wskaż folder';de = 'Geben Sie das Verzeichnis an';ro = 'Indicați directorul';tr = 'Dizini belirtin'; es_ES = 'Especificar el directorio'") );
	
	SetDefaultStructureValues(DialogParameters, DialogDefaultOptions);
	
	WarningText = NStr("ru = 'Для данной операции необходимо установить расширение для веб-клиента 1С:Предприятие.'; en = 'This operation requires the extension for 1C:Enterprise web client.'; pl = 'Zainstaluj rozszerzenie klienta sieci web 1C:Enterprise dla tej operacji.';de = 'Installieren Sie die Erweiterung für 1C: Enterprise Web Client für diesen Vorgang.';ro = 'Pentru continuarea operației trebuie să instalați extensia pentru web-clientul 1C:Enterprise.';tr = 'Bu işlem için 1C: İşletme web istemcisi için uzantı yükleyin.'; es_ES = 'Instalar la extensión para el cliente web de la 1C:Empresa para esta operación.'");
	...
	FileSystemClient.AttachFileOperationsExtension(Notification, WarningText, False);
EndProcedure
...
//     CompletionNotification  - NotifyDescription - an optional notification that is called with 
//                                                  the following parameters:
//                                 Result               - String, Undefined - the selected value 
//                                                                                  (array of strings if multiple selection is used or
...
Procedure FileSelectionHandler(Object, Val PropertyName, StandardProcessing = False, Val DialogParameters = Undefined, CompletionNotification = Undefined) Export
	...
	DialogDefaultOptions.Insert("Title",                   NStr("ru = 'Выберите файл'; en = 'Select file'; pl = 'Wybierz plik';de = 'Datei auswählen';ro = 'Selectați fișierul';tr = 'Dosya seç'; es_ES = 'Seleccionar un archivo'"));
...
Procedure SelectAndSaveFileAtClientAfterAttachFileSystemExtension(Attached, AdditionalParameters) Export
	...
	DialogDefaultOptions = New Structure;
	DialogDefaultOptions.Insert("Title",               NStr("ru = 'Выберите файл для сохранения'; en = 'Select file to download'; pl = 'Wybierz plik, który chcesz zapisać';de = 'Wählen Sie eine Datei zum Speichern aus';ro = 'Selectați fișierul pentru salvare';tr = 'Kaydedilecek dosyayı seçin'; es_ES = ' Seleccione un archivo para guardar'"));
	DialogDefaultOptions.Insert("Multiselect",      False);
	DialogDefaultOptions.Insert("Preview", False);
...
Procedure OpenInstructionHowToChangeDataSynchronizationPassword(Val AccountPasswordRecoveryAddress) Export
	...
	If IsBlankString(AccountPasswordRecoveryAddress) Then
		...
		ShowMessageBox(, NStr("ru = 'Адрес инструкции для восстановления пароля учетной записи не задан.'; en = 'The address of the password recovery instruction is not specified.'; pl = 'Adres instrukcji dla odzyskiwania hasła konta nie jest podany.';de = 'Die Adresse der Anweisung zur Wiederherstellung des Kontopassworts ist nicht angegeben.';ro = 'Adresa ghidului de restabilire a parolei contului nu este specificată.';tr = 'Hesap şifresi kurtarma talimatının adresi belirlenmedi.'; es_ES = 'Dirección de instrucción para recuperar la contraseña de la cuenta no está establecida.'"));
...
Function OpenExportAdditionFormAllDocuments(Val ExportAddition, Val Owner=Undefined, Val Uniqueness=Undefined, Val Window=Undefined) Export
	...
	FormParameters.Insert("Title", NStr("ru='Добавление документов для отправки'; en = 'Add documents to send'; pl = 'Dodaj dokument do wysłania';de = 'Fügen Sie Dokumente zum Senden hinzu';ro = 'Adăugarea documentelor pentru trimitere';tr = 'Gönderilecek belgeleri ekle'; es_ES = 'Agregar documentos para enviar'") );
