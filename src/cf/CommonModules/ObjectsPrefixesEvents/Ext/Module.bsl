...
Function CompanyAttributeAvailable(Object)
	...
	If   (Common.IsCatalog(ObjectMetadata)
		...
		If CompanyAttribute = Undefined Then
			...
			MessageString = NStr("ru = 'Для объекта метаданных %1 не определен реквизит с именем %2.'; en = '%2 attribute is not defined for %1 metadata object.'; pl = 'Dla obiektu metadanych %1 nie określono atrybutu o nazwie ""%2"".';de = 'Das Attribut mit dem Namen ""%2"" ist nicht für das Metadatenobjekt definiert %1.';ro = 'Atributul cu numele %2 nu este definit pentru obiectul de metadate %1.';tr = '%2 adlı metadata nesnesi için %1öznitelik tanımlanmadı.'; es_ES = 'Atributo con el nombre ""%2"" no está definido para el objeto de metadatos %1.'");
