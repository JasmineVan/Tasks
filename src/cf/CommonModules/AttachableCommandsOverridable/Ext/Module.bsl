...
//
// When integrating the "Printing", "Object filling", and "Report options" subsystems to the 
// configuration, in the Settings parameter of the OnDefineSettings procedure of the report and data 
// processor manager modules, a number of standard properties is predefined, in which you can set the following:
...
//           For more information, see AttachableCommandsOverridable.OnDefineAttachableCommandsKinds. 
...
//                                          handler parameters instead of references. In this mode, 
//                                          we recommend that you operate directly with a form that is passed in the structure of parameter 2 of the command handler.
...
//             install the file system extension. Optional. Default value is False.
//     
//     Handler settings:
