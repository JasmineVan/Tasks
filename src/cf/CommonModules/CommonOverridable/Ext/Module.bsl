...
//     It is required to find the "technical" objects in the handler that contain the reference to 
//     the object to be deleted in the attributes and select the way of reference clearing: clear the attribute value, delete the row, or delete the whole object.
...
//                subsystem is not in the configuration).
//
...
//  DataItem             - Arbitrary - see the details of the handler of the same name in the Syntax Assistant.
//  ItemSend          - DataItemSend - see the details of the handler of the same name in the Syntax Assistant.
//  InitialImageCreation  - Boolean - see the details of the handler of the same name in the Syntax Assistant.
//
Procedure OnSendDataToSlave(Source, DataItem, ItemSending, InitialImageCreation) Export
...
//  ItemSend  - DataItemSend - see the details of the handler of the same name in the Syntax Assistant.
//
Procedure OnSendDataToMaster(Source, DataItem, ItemSending) Export
...
//  Source - ExchangePlanObject - a node, for which the exchange is performed.
//  DataItem     - Arbitrary - see the details of the handler of the same name in the Syntax Assistant.
//  GetItem - GetDataItem - see the details of the handler of the same name in the Syntax Assistant.
