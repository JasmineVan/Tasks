...
//                                                                  implemented.
//    * AskEditingModeOnOpenFile    - Boolean - available only if the "Stored files" subsystem is 
//                                                                  implemented. 
//    * ShowColumnSize                          - Boolean - available only if the "Stored files" 
//                                                                  subsystem is implemented.
//    * DoubleClickAction                     - String -  available only if the "Stored files" 
//                                                                  subsystem is implemented.
//    * FilesVersionsComparisonMethod                      - String - available only if the "Stored 
...
Procedure SaveFilesOperationSettings(FilesOperationsSettings) Export
	...
	FilesOperations.SaveFilesOperationSettings(FilesOperationsSettings);
