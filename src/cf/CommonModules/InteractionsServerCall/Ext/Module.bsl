...
Function SendReceiveUserEmailInBackground(UUID) Export
	...
	ExecutionParameters.BackgroundJobDescription = NStr("ru = 'Получение и отправка электронной почты пользователя'; en = 'Receive and send user emails'; pl = 'Receive and send user emails';de = 'Receive and send user emails';ro = 'Receive and send user emails';tr = 'Receive and send user emails'; es_ES = 'Receive and send user emails'");
...
Function EmailDataToSaveAsFile(Email, UUID) Export
	...
	If EmailData <> Undefined Then
		...
		FileData.FullDescriptionVersion = FileData.FileName;
...
Function UserEmailSendingReceivingResult(ResultAddress) Export
...
Function FileDataStructure()
	...
	FileDataStructure.Insert("FullDescriptionVersion",           "");
