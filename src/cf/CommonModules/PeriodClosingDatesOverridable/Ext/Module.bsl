...
//   * EnableExternalUsers - Boolean - (initial value is False) if you set to True, period-end 
...
//       for example, Type("CatalogRef.Companies"), if no type is specified, period-end closing 
//       dates are set up only to the precision of a section.
//
...
//   * DateField    - String - an attribute name of an object or a tabular section, for example: 
//                   "Date", "Goods.ShipmentDate".
...
//   * ObjectField - String - an attribute name of an object or a tabular section, for example: 
//                   "Company", "Goods.Warehouse".
//
