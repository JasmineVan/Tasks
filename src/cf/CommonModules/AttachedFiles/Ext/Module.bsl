...
// Obsolete.
// Use FilesOperations.FileBinaryData.
...
// Obsolete.
// Use FilesOperations.NewRefToFile instead.
...
// Requires the "Stored files" subsystem.
//
...
// Returns references to the objects with files from the "Stored files" subsystem.
// Requires the "Stored files" subsystem.
//
...
//
Procedure OverrideAttachedFileForm(Source, FormKind, Parameters,
			SelectedForm, AdditionalInformation, StandardProcessing) Export
	
	FilesOperations.DetermineAttachedFileForm(Source, FormKind, Parameters,
