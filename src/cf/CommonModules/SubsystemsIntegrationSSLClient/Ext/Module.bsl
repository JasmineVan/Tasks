...
Procedure BeforeStart(Parameters) Export
	...
	If CommonClient.SubsystemExists(
	       "SaaSTechnology.SaaS.DataExchangeSaaS") Then
...
Procedure OnCheckIfCanBackUpInUserMode(Result) Export
	...
	If CommonClient.SubsystemExists("SaaSTechnology.IBBackup") Then
		ModuleIBBackupClient = CommonClient.CommonModule("IBBackupClient");
		ModuleIBBackupClient.OnCheckIfCanBackUpInUserMode(Result);
	EndIf;
	
	If CommonClient.SubsystemExists("SaaSTechnology.DataAreaBackup") Then
		ModuleDataAreasBackupClient = CommonClient.CommonModule("DataAreaBackupClient");
		ModuleDataAreasBackupClient.OnCheckIfCanBackUpInUserMode(Result);
	EndIf;
...
Procedure OnPromptUserForBackup() Export
	...
	If CommonClient.SubsystemExists("SaaSTechnology.DataAreaBackup") Then
		ModuleDataAreasBackupClient = CommonClient.CommonModule("DataAreaBackupClient");
		ModuleDataAreasBackupClient.OnPromptUserForBackup();
	EndIf;
