...
Function DatesBySchedule(Val WorkSchedule, Val DateFrom, Val DaysArray, 
	...
	While Selection.Next() Do
		If Selection.DateByCalendar = Undefined Then
			ErrorMessage = NStr("ru = 'График работы «%1» не заполнен с даты %2 на указанное количество рабочих дней.'; en = 'Cannot determine the date because work schedule ""%1"" is not filled for the specified number of workdays after %2.'; pl = 'Harmonogram pracy ""%1"" nie jest wypełniony od daty %2 na wskazaną ilość dni roboczych.';de = 'Der Arbeitszeitplan ""%1"" wird nicht ab dem Datum %2 der angegebenen Anzahl von Arbeitstagen ausgefüllt.';ro = 'Programul de lucru ""%1"" nu este completat de la data %2 pentru numărul specificat de zile lucrătoare.';tr = '""%1"" Çalışma takvimi belirtilen sayıda çalışma günü için%2 tarihinden itibaren doldurulmamıştır.'; es_ES = 'El horario ""%1"" no está rellenado de la fecha %2 para la cantidad de los días laborables indicada.'");
