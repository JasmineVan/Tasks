...
//
Procedure RemindInSpecifiedTime(Text, Time, Topic = Undefined) Export
...
Procedure RemindTillSubjectTime(Text, Interval, Topic, AttributeName) Export
	
	Reminder = UserRemindersServerCall.AttachReminderTillSubjectTime(
		Text, Interval, Topic, AttributeName, False);
...
//               - String - a name of a reminder subject attribute that contains event start time.
...
//
Procedure Remind(Text, EventTime, IntervalTillEvent = 0, Topic = Undefined, ID = Undefined) Export
...
//  AttributeName - String - a name of the subject attribute, for which the reminder period is set.
//
Procedure RemindOfAnnualSubjectEvent(Text, Interval, Topic, AttributeName) Export
	
	Reminder = UserRemindersServerCall.AttachReminderTillSubjectTime(
		Text, Interval, Topic, AttributeName, True);
