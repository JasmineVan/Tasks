...
//    * ApplicationChangeHistoryLocation - String - provides location of a command used to open the 
...
//    * DefaultInfobaseUpdateThreadsCount - String - the number of deferred update threads used by 
...
// about versions of subsystems using InfobaseUpdate.InfobaseVersion, InfobaseUpdate.
// SetInfobaseVersion, and InfobaseUpdate.RegisterNewSubsystem.
// 
//
// Example:
...
// version updates at first launch of a program (right after an update), and also perform other 
// actions.
//
...
//       * CompletedHandlers - ValueTree - completed update handlers, grouped by library and version 
//                                   number. See column details in InfobaseUpdate.
//                                   NewUpdateHandlerTable.
...
// Called upon creating a document containing details of new version updates that are displayed for 
// the user at the first application startup (after update).
//
// Parameters:
//   Template - SpreadsheetDocument - description of new version updates automatically formed from 
//                               the ShowChangeHistory common template.
