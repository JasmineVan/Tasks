...
//
// Example:
//  StringFunctions.FormattedString(NStr("en='<span style=""color: LockedAttributeColor; font:
//  ImportantLabelFont""> The lowest</span> supported version is <b>1.1</b>. <a href = ""Update"">Update</a>
//  the application.'")); StringFunctions.FormattedString(NStr("en='Mode: <img src=""EditInDialog""> 
...
//  StringFunctions.FormattedString(NStr("en='Current date <img src=""Calendar""><span style=""font:
