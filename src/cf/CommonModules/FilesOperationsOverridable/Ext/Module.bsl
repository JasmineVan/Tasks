...
//                      When calling, it contains standard name of a catalog marked as main (if it 
//                      exists).
...
//
// Parameters:
//  FileData    - Structure - a file info, see FilesOperations.FileData. 
...
// are not provided in SSL and were added to the Files or FilesVersions catalog in the configuration.
//
// Parameters:
...
//  SendingParameters - Structure - a parameter to be returned, see EmailOperationsClient. EmailSendingParameters.
//  FilesOwner    - DefinedType.AttachedFilesOwner - an object that owns files.
//  UUID - UUID - an UUID required for storing data to a temporary storage.
//                
//
...
//
// Parameters:
//    Form - ManagedForm - a file list form.
